...
public class IndexCoprocIT extends ParallelStatsDisabledIT {
    ...
    public void testCreateCoprocs() throws Exception {
        ...
        props.put(IndexUtil.CODEC_CLASS_NAME_KEY, PhoenixIndexCodec.class.getName());
        IndexerStatic.enableIndexing(baseDescBuilder, PhoenixIndexBuilder.class.getName(),
