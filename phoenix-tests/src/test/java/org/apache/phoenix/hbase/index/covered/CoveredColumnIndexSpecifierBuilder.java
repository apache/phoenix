...
public class CoveredColumnIndexSpecifierBuilder {
  ...
  public TableDescriptor build(TableDescriptor desc, Class<? extends IndexCodec> clazz) throws IOException {
    ...
    opts.put(IndexUtil.CODEC_CLASS_NAME_KEY, clazz.getName());
        TableDescriptorBuilder newBuilder = TableDescriptorBuilder.newBuilder(desc);
        IndexerStatic.enableIndexing(newBuilder, NonTxIndexBuilder.class.getName(), opts, Coprocessor.PRIORITY_USER);
