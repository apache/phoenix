...
import static org.apache.phoenix.hbase.index.IndexRegionObserverConstants.UNVERIFIED_BYTES;
import static org.apache.phoenix.hbase.index.IndexRegionObserverConstants.VERIFIED_BYTES;
import static org.apache.phoenix.hbase.index.IndexRegionObserverConstants.PHOENIX_APPEND_METADATA_TO_WAL;
import static org.apache.phoenix.hbase.index.IndexRegionObserverConstants.DEFAULT_PHOENIX_APPEND_METADATA_TO_WAL;
            ...
            for (Pair<IndexMaintainer, HTableInterfaceReference> pair : indexTables) {
                ...
                if (nextDataRowState != null) {
                    ...
                    if (indexPut == null) {
                        ...
                        IndexRegionObserverConstants.removeEmptyColumn(indexPut, indexMaintainer.getEmptyKeyValueFamily().copyBytesIfNecessary(),
