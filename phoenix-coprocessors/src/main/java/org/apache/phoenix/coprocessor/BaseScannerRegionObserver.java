...
import static org.apache.phoenix.coprocessor.BaseScannerRegionObserverConstants.EXPECTED_UPPER_REGION_KEY;
import static org.apache.phoenix.coprocessor.BaseScannerRegionObserverConstants.SCAN_ACTUAL_START_ROW;
import static org.apache.phoenix.coprocessor.BaseScannerRegionObserverConstants.SKIP_REGION_BOUNDARY_CHECK;
import static org.apache.phoenix.coprocessor.BaseScannerRegionObserverConstants.TX_SCN;
import static org.apache.phoenix.coprocessor.BaseScannerRegionObserverConstants.SERVER_PAGE_SIZE_MS;
import static org.apache.phoenix.coprocessor.BaseScannerRegionObserverConstants.REPLAY_TABLE_AND_INDEX_WRITES;
import static org.apache.phoenix.coprocessor.BaseScannerRegionObserverConstants.REPLAY_ONLY_INDEX_WRITES;
import static org.apache.phoenix.coprocessor.BaseScannerRegionObserverConstants.REPLAY_INDEX_REBUILD_WRITES;
    ...
    public void preScannerOpen(org.apache.hadoop.hbase.coprocessor.ObserverContext<RegionCoprocessorEnvironment> c,
        ...
        if (isRegionObserverFor(scan)) {
            ...
            if (scan.getFilter() != null && !(scan.getFilter() instanceof PagedFilter)) {
                byte[] pageSizeMsBytes = scan.getAttribute(SERVER_PAGE_SIZE_MS);
