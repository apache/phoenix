...
public class IndexUpgradeTool extends Configured implements Tool {
    ...
    public void prepareToolSetup() {
        try {
            ...
            prop.put(IndexerStatic.INDEX_BUILDER_CONF_KEY, PhoenixIndexBuilder.class.getName());
            prop.put(IndexUtil.CODEC_CLASS_NAME_KEY, PhoenixIndexCodec.class.getName());
