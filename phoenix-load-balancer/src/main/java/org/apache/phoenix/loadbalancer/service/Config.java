...
public class Config {
    ...
    private  String clusterName = "phoenix.queryserver.base.path";
    private  String serviceName = "phoenix.queryserver.service.name";
    private  String defaultClusterName = "phoenix";
    private  String defaultServiceName = "queryserver";
    private  String zkQuorum = "hbase.zookeeper.quorum";
    private  String zkPort = "hbase.zookeeper.property.clientPort";
