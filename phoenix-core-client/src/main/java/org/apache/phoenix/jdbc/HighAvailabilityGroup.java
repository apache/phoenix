...
public class HighAvailabilityGroup {
  ...
  public static HAGroupInfo getHAGroupInfo(String url, Properties properties) throws SQLException {
   ...
   * {@link #connectActive(Properties)} to connect to the ACTIVE cluster.
   */
