...
public class ParallelPhoenixStatement implements PhoenixMonitoredStatement {
  ...
  public ParallelPhoenixStatement(ParallelPhoenixContext context,
    CompletableFuture<PhoenixMonitoredStatement> statement1,
    CompletableFuture<PhoenixMonitoredStatement> statement2) throws SQLException {
  ...
  public ResultSet executeQuery(String sql) throws SQLException {
    ...
    List<CompletableFuture<ResultSet>> futures = ParallelPhoenixUtil.INSTANCE
      .applyFunctionToFutures(function, statement1, statement2, context, true);
