...
public class LoggingPhoenixConnection extends DelegateConnection {
  ...
  public Statement createStatement() throws SQLException {
    return new LoggingPhoenixStatement(super.createStatement(), phoenixMetricsLog, this);
  }

  @Override
  public Statement createStatement(int resultSetType, int resultSetConcurrency)
    throws SQLException {
    return new LoggingPhoenixStatement(super.createStatement(resultSetType, resultSetConcurrency),
  ...
  public PreparedStatement prepareStatement(String sql) throws SQLException {
    return new LoggingPhoenixPreparedStatement(super.prepareStatement(sql), phoenixMetricsLog, sql,
      this);
  }
  ...
  public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency)
    ...
    return new LoggingPhoenixPreparedStatement(
      super.prepareStatement(sql, resultSetType, resultSetConcurrency), phoenixMetricsLog, sql,
      this);
  }
