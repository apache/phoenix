...
public class ParallelPhoenixPreparedStatement implements PhoenixMonitoredPreparedStatement {
  ...
  public ParallelPhoenixPreparedStatement(ParallelPhoenixContext context,
    CompletableFuture<PhoenixMonitoredPreparedStatement> statement1,
    CompletableFuture<PhoenixMonitoredPreparedStatement> statement2) throws SQLException {
  ...
  Object runOnPreparedStatements(Function<PhoenixMonitoredPreparedStatement, ?> function)
    throws SQLException {
