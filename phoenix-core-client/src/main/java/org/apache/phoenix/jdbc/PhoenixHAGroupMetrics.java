...
public class PhoenixHAGroupMetrics implements PhoenixMetricsHolder {
  ...
  public enum HAMetricType {
    HA_PARALLEL_COUNT_FAILED_OPERATIONS(
      ImmutableList.of(HA_PARALLEL_COUNT_FAILED_OPERATIONS_ACTIVE_CLUSTER,
    ...
    HA_PARALLEL_COUNT_OPERATIONS(ImmutableList.of(HA_PARALLEL_COUNT_OPERATIONS_ACTIVE_CLUSTER,
