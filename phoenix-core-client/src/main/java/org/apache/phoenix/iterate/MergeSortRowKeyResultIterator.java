...
/**
 * ResultIterator that does a merge sort on the list of iterators provided, returning the rows in
 * row key ascending order. The iterators provided must be in row key ascending order.
 * @since 0.1
 */
public class MergeSortRowKeyResultIterator extends MergeSortResultIterator {
  ...
  public String toString() {
    return "MergeSortRowKeyResultIterator [keyOffset=" + keyOffset + ", factor=" + factor + "]";
  }
}
