...
public class ViewUtil {
  ...
  public static Pair<List<PTable>, List<TableInfo>> findAllDescendantViews(
    ...
    boolean findJustOneLegitimateChildView) throws IOException, SQLException {
  ...
  public static Pair<List<PTable>, List<TableInfo>> findAllDescendantViews(
    ...
    Pair<Boolean, Boolean> scanSysCatForTTLDefinedOnAnyChildPair) throws IOException, SQLException {
   ...
   * {@link ViewUtil#findAllDescendantViews(Table, Configuration, byte[], byte[], byte[], long, boolean)}
