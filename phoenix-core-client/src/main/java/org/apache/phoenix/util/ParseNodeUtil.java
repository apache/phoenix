...
public class ParseNodeUtil {
   ...
   */
  public static <T> void applyParseNodeVisitor(SelectStatement selectStatement,
    ParseNodeVisitor<T> parseNodeVisitor) throws SQLException {
   ...
   */
  public static <T> void applyParseNodeVisitor(SelectStatement selectStatement,
    ParseNodeVisitor<T> parseNodeVisitor, boolean applyWhere) throws SQLException {
  ...
  /**
   * Collect referenced columnNames in selectStatement, the selectStatement is a single table query,
   * not a join.
   */
  public static Set<String> collectReferencedColumnNamesForSingleTable(
    SelectStatement selectStatement) throws SQLException {
