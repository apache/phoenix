...
public class JDBCUtil {
  ...
  /**
   * Get the ZK quorom and root and node part of the URL, which is used by the HA code internally to
   * identify the clusters. As we interpret a missing protocol as ZK, this is mostly idempotent for
   * zk quorum strings.
