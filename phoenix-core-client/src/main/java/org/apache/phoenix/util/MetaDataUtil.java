...
public class MetaDataUtil {
   ...
   * @return Input max lookback age, if not null. If null, fallback to cluster level max lookback
   *         age. Will always return non-null long value.
   */
  public static long getMaxLookbackAge(Configuration conf, Long maxLookbackAge) {
    Preconditions.checkNotNull(conf);
    return maxLookbackAge != null
      ? maxLookbackAge
