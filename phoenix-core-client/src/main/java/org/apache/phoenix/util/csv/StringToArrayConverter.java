...
class StringToArrayConverter {
  ...
  public StringToArrayConverter(Connection conn, String separatorString,
    ...
    this.elementConvertFunction =
      new CsvUpsertExecutor.SimpleDatatypeConversionFunction(elementDataType, this.conn);
  }
  ...
  public Array toArray(String input) throws SQLException {
    ...
    return conn.createArrayOf(elementDataType.getSqlTypeName(), Lists
      .newArrayList(Iterables.transform(splitter.split(input), elementConvertFunction)).toArray());
  }
}
