...
public interface QueryConstants {
    ...
    String CREATE_HA_GROUP_METADATA = "CREATE TABLE " + SYSTEM_CATALOG_SCHEMA + ".\"" +
            ...
            VERSION_1 + " BIGINT," +  // Version should be incremented for Admin Updates, only for CLUSTER_URLs and REGISTRY_TYPE
            VERSION_2 + " BIGINT," +  // Version should be incremented for Admin Updates, only for CLUSTER_URLs and REGISTRY_TYPE
            "CONSTRAINT " + SYSTEM_TABLE_PK_NAME +
