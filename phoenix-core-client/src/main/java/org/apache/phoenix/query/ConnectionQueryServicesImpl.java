...
public class ConnectionQueryServicesImpl extends DelegateQueryServices implements ConnectionQueryServices {
    ...
    private PhoenixConnection upgradeSystemCatalogIndexes(PhoenixConnection metaConnection)
        ...
        try (PhoenixConnection conn = new PhoenixConnection(
            ...
            conn.createStatement().execute("CREATE INDEX IF NOT EXISTS INDEX_HDR_SYS_INDEX ON SYSTEM.CATALOG(TENANT_ID, TABLE_SCHEM, TABLE_NAME, COLUMN_NAME, COLUMN_FAMILY, INDEX_STATE) INCLUDE (TABLE_TYPE) WHERE TABLE_TYPE = 'i' AND INDEX_STATE IS NOT NULL ASYNC");
            conn.createStatement().execute("CREATE INDEX IF NOT EXISTS VIEW_HDR_SYS_INDEX_ ON SYSTEM.CATALOG(TENANT_ID, TABLE_SCHEM, TABLE_NAME, COLUMN_NAME, COLUMN_FAMILY) INCLUDE (TABLE_TYPE, VIEW_STATEMENT, TTL, ROW_KEY_MATCHER) WHERE TABLE_TYPE = 'v' ASYNC");
