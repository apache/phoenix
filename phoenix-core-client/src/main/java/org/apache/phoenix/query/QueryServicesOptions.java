...
public class QueryServicesOptions {
    ...
    public static final Boolean DEFAULT_PROFILE_BASED_THREAD_POOL_ENABLED = false;
    public static final int DEFAULT_PROFILE_BASED_THREAD_POOL_KEEP_ALIVE_SECONDS = 60;
    public static final int DEFAULT_PROFILE_BASED_THREAD_POOL_CORE_POOL_SIZE = 50;
    public static final int DEFAULT_PROFILE_BASED_THREAD_POOL_MAX_THREADS = 100;
    public static final int DEFAULT_PROFILE_BASED_THREAD_POOL_MAX_QUEUE = 512;
    ...
    public static QueryServicesOptions withDefaults() {
        ...
        QueryServicesOptions options = new QueryServicesOptions(config)
            ...
            .setIfUnset(PROFILE_BASED_THREAD_POOL_ENABLED, DEFAULT_PROFILE_BASED_THREAD_POOL_ENABLED)
            .setIfUnset(PROFILE_BASED_THREAD_POOL_KEEP_ALIVE_SECONDS, DEFAULT_PROFILE_BASED_THREAD_POOL_KEEP_ALIVE_SECONDS)
            .setIfUnset(PROFILE_BASED_THREAD_POOL_CORE_POOL_SIZE, DEFAULT_PROFILE_BASED_THREAD_POOL_CORE_POOL_SIZE)
            .setIfUnset(PROFILE_BASED_THREAD_POOL_MAX_THREADS, DEFAULT_PROFILE_BASED_THREAD_POOL_MAX_THREADS)
            .setIfUnset(PROFILE_BASED_THREAD_POOL_MAX_QUEUE, DEFAULT_PROFILE_BASED_THREAD_POOL_MAX_QUEUE);
