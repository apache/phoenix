...
public final class PhoenixConfigurationUtilHelper {
  ...
  static {
    Configuration.addDeprecation("phoneix.mapreduce.output.cluster.quorum",
      PhoenixConfigurationUtilHelper.MAPREDUCE_OUTPUT_CLUSTER_QUORUM);
  }
  ...
  /**
   * Get the value of the <code>name</code> property as a set of comma-delimited <code>long</code>
   * values. If no such property exists, null is returned. Hadoop Configuration object has support
   * for getting ints delimited by comma but doesn't support for long.
   * @param name property name
   * @return property value interpreted as an array of comma-delimited <code>long</code> values
   */
