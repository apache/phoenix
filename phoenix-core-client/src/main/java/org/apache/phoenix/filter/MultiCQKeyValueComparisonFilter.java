 ...
 * multiple unique column qualifiers over one or more column families.
 */
public class MultiCQKeyValueComparisonFilter extends MultiKeyValueComparisonFilter {
  ...
  public MultiCQKeyValueComparisonFilter(Expression expression, boolean allCFs,
    byte[] essentialCF) {
  ...
  public static MultiCQKeyValueComparisonFilter parseFrom(final byte[] pbBytes)
    throws DeserializationException {
    try {
      return (MultiCQKeyValueComparisonFilter) Writables.getWritable(pbBytes,
        new MultiCQKeyValueComparisonFilter());
    } catch (IOException e) {
