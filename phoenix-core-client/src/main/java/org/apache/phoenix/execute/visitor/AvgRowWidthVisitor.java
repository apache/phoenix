...
/**
 * Implementation of QueryPlanVisitor used to get the average number of bytes each row for a
 * QueryPlan.
 */
public class AvgRowWidthVisitor implements QueryPlanVisitor<Double> {
  ...
  /*
   * The below methods provide estimation of row width based on the input row width as well as the
   * operator.
   */
