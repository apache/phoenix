...
public class ConnectionQueryServicesMetrics {
  ...
  public enum QueryServiceMetrics {
    ...
    CONNECTION_QUERY_SERVICE_CREATION_TIME(PHOENIX_CONNECTION_CREATION_DURATION_MS);
  ...
  /**
   * This function is used to update the value of Metric In case of counter val will be passed as 1.
