...
public class QueryLogger {
  ...
  public static QueryLogger getInstance(PhoenixConnection connection, boolean isSystemTable) {
    if (
      connection.getLogLevel() == LogLevel.OFF || isSystemTable
  ...
  /**
   * Return queryId of the current query logger , needed by the application to correlate with the
   * logging table. Eg(usage):- StatementContext context = ((PhoenixResultSet)rs).getContext();
