...
/**
 * Function used to bucketize date/time values by truncating them to an even increment. Usage:
 ...
 * @since 0.1
 */
@BuiltInFunction(name = TruncFunction.NAME, nodeClass = FloorParseNode.class,
