 ...
 * <p>
 * {@code source_str} is the string in which we want to split. {@code split_pattern} is a Java
 * compatible regular expression string to split the source string. The function returns a
 * {@link org.apache.phoenix.schema.types.PVarcharArray}
 */
@FunctionParseNode.BuiltInFunction(name = RegexpSplitFunction.NAME,
    nodeClass = RegexpSplitParseNode.class,
