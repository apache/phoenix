...
/** Computes squared Euclidean distance: {@code sum((a[i] - b[i])^2)}. */
@BuiltInFunction(name = L2DistanceSquaredFunction.NAME,
    nodeClass = L2DistanceSquaredParseNode.class,
...
public class L2DistanceSquaredFunction extends DistanceFunction {

  public static final String NAME = "L2_DISTANCE_SQUARED";

  public L2DistanceSquaredFunction() {
  }

  public L2DistanceSquaredFunction(List<Expression> children) {
    super(children);
  }

  public L2DistanceSquaredFunction(List<Expression> children, double distanceUpperBound) {
  ...
  public static double l2DistanceSquared(byte[] a, int aOff, byte[] b, int bOff, int dim) {
  ...
  public static double l2DistanceSquaredWithBound(byte[] a, int aOff, byte[] b, int bOff, int dim,
    double bound) {
    return VectorDistanceUtil.l2DistanceSquaredWithBound(a, aOff, b, bOff, dim, bound);
  }
  ...
  public static double compute(byte[] buf1, int off1, SortOrder order1, boolean isDouble1,
    ...
    if (!isDouble1 && !isDouble2 && order1 == SortOrder.ASC && order2 == SortOrder.ASC) {
      return VectorDistanceUtil.l2DistanceSquaredWithBound(buf1, off1, buf2, off2, dim, bound);
    }
