...
public class CeilDateExpression extends RoundDateExpression {
  ...
  /**
   * @param timeUnit - unit of time to round up to. Creates a {@link CeilDateExpression} with
   ...
   * @param multiplier - determines the roll up window size. Create a {@link CeilDateExpression}.
   */
