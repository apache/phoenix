...
@BuiltInFunction(name = AvgAggregateFunction.NAME, nodeClass = AvgAggregateParseNode.class,
...
public class AvgAggregateFunction extends CompositeAggregateFunction {
  ...
  public AvgAggregateFunction(List<Expression> children, CountAggregateFunction countFunc,
  ...
  public boolean evaluate(Tuple tuple, ImmutableBytesWritable ptr) {
    ...
    if (!countFunc.isConstantExpression()) {
      ...
      // For the final column projection, we divide the sum by the count, both coerced to
      // BigDecimal.
