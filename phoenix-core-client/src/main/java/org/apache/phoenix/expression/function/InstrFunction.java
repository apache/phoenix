...
@BuiltInFunction(name = InstrFunction.NAME, args = { @Argument(allowedTypes = { PVarchar.class }),
...
public class InstrFunction extends ScalarFunction {
  ...
  /**
   * Extracts the string-representation of {@code expr} only if {@code expr} is a non-null
