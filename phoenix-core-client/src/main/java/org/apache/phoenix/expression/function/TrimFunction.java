...
/**
 * Implementation of the {@code Trim(<string>) } build-in function. It removes from both end of
 * {@code <string> } space character and other function bytes in single byte utf8 characters set.
 * @since 0.1
 */
@BuiltInFunction(name = TrimFunction.NAME, args = { @Argument(allowedTypes = { PVarchar.class }) })
