...
/**
 * Implementation of ENCODE(input number, format encodeformat) Converts the given base 10 number to
 * a base 62 number and returns a string representing the number.
 */
@BuiltInFunction(name = EncodeFunction.NAME,
    args = { @Argument(allowedTypes = { PLong.class }), @Argument(enumeration = "EncodeFormat") })
