...
/**
 * Implementation of the {@code LENGTH(<string>) } build-in function. {@code <string> } is the
 * string of characters we want to find the length of. If {@code <string> } is NULL or empty, null
 * is returned.
 * @since 0.1
 */
@BuiltInFunction(name = LengthFunction.NAME,
