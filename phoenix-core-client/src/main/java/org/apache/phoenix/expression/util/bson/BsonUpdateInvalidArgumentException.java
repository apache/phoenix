...
/**
 * Exception thrown when invalid arguments are provided to BSON update expressions.
 */
public class BsonUpdateInvalidArgumentException extends IllegalArgumentException {
