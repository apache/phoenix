 ...
 * {@code NTH_VALUE(<expression>, <expression>) WITHIN GROUP (ORDER BY <expression> ASC/DESC) }
 * aggregate function
 */
@FunctionParseNode.BuiltInFunction(name = NthValueFunction.NAME,
    nodeClass = NthValueAggregateParseNode.class,
