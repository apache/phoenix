  ...
  public QueryPlan compileSelect(SelectStatement select) throws SQLException {
    ...
    if (dataPlanForCDC != null) {
      ...
      NamedTableNode cdcDataTableName =
        NODE_FACTORY.namedTable(null, NODE_FACTORY.table(cdcTable.getSchemaName().getString(),
    ...
    if (table.getType() == PTableType.CDC) {
      ...
      if (orderByNodes.size() == 0) {
        ...
        orderByNodes.add(NODE_FACTORY.orderBy(
          NODE_FACTORY.function(PhoenixRowTimestampFunction.NAME, Collections.emptyList()), false,
          SortOrder.getDefault() == SortOrder.ASC));
      }
