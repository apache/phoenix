...
public class GuidePostsInfoBuilder {
  ...
  public boolean addGuidePostOnCollection(ImmutableBytesWritable row, long byteCount,
     ...
     * created/updated at. So passing it as 0 here. The update/create timestamp is important when we
     * are reading guideposts out of the SYSTEM.STATS table.
     */
  ...
  public GuidePostsInfo build() {
    ...
    GuidePostsInfo guidePostsInfo = new GuidePostsInfo(this.byteCounts, this.guidePosts,
      this.rowCounts, this.maxLength, this.guidePostsCount, this.guidePostsTimestamps);
