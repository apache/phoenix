...
public class ReadOnlyTableException extends SQLException {
  ...
  public ReadOnlyTableException(String message, String schemaName, String tableName) {
    super(new SQLExceptionInfo.Builder(code).setSchemaName(schemaName).setTableName(tableName)
      .setMessage(message).toString(), code.getSQLState(), code.getErrorCode());
  }
  ...
  public ReadOnlyTableException(String message, String schemaName, String tableName,
    ...
    super(
      new SQLExceptionInfo.Builder(code).setSchemaName(schemaName).setTableName(tableName)
        .setRootCause(cause).setMessage(message).toString(),
  ...
  public ReadOnlyTableException(String message, String schemaName, String tableName,
    ...
    super(
      new SQLExceptionInfo.Builder(code).setSchemaName(schemaName).setTableName(tableName)
        .setFamilyName(familyName).setMessage(message).toString(),
