...
public class Task {
  ...
  protected static List<Mutation> executeStatementAndGetTaskMutations(PhoenixConnection conn,
  ...
  protected static PreparedStatement setValuesToAddTaskPS(PreparedStatement stmt,
  ...
  protected static PreparedStatement addTaskAndGetStatement(SystemTaskParams systemTaskParams,
    PhoenixConnection connection) throws IOException {
  ...
  public static List<Mutation> getMutationsForAddTask(SystemTaskParams systemTaskParams)
    ...
    try (PhoenixConnection newConnection = QueryUtil
      ...
      try (PreparedStatement statement = addTaskAndGetStatement(systemTaskParams, newConnection)) {
        return executeStatementAndGetTaskMutations(newConnection, statement);
      }
    }
  }
  ...
  public static class TaskRecord {
    ...
    public boolean isMatchingTask(SystemTransformRecord transformRecord) {
      ...
      if (
        StringUtils.equals(transformRecord.getLogicalTableName(), getTableName())
