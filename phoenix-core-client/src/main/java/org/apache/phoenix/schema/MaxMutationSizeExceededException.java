...
/**
 * Exception thrown when MutationState size is bigger than maximum allowed number of rows
 */
...
public class MaxMutationSizeExceededException extends SQLException {
  ...
  public MaxMutationSizeExceededException(int maxMutationSize, int mutationSize) {
    super(
      new SQLExceptionInfo.Builder(code).setMaxMutationSize(maxMutationSize)
