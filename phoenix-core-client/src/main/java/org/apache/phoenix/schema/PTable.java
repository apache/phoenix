...
public interface PTable extends PMetaDataEntity {
  ...
  /** Returns The PHOENIX_TTL duration associated with the entity. */
  long getPhoenixTTL();

  /** Returns The PHOENIX_TTL high water mark timestamp associated with the entity. */
  long getPhoenixTTLHighWaterMark();

  /** Returns If the view has overridden the TTL set at the parent entity level. */
