...
public interface PTable extends PMetaDataEntity {
    ...
    /**
     * @return Prefixed KeyRange generated by the expression representing the view statement. In
     * other words this will be one-to-one mapping between view and PREFIXED KeyRange that'll exist.
     */
