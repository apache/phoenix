 ...
 * some other format interpretable by an external system. Possible implementing classes would
 * include converters to Avro, Protobuf, Thrift, various dialects of SQL, or other similar
 * cross-platform data description languages.
 */
