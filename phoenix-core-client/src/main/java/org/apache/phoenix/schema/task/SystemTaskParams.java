...
/**
 * Task params to be used while upserting records in SYSTEM.TASK table. This POJO is mainly used
 * while upserting(and committing) or generating upsert mutations plan in {@link Task} class
 */
...
public class SystemTaskParams {
  ...
  public SystemTaskParams(PhoenixConnection conn, PTable.TaskType taskType, String tenantId,
    String schemaName, String tableName, String taskStatus, String data, Integer priority,
    Timestamp startTs, Timestamp endTs, boolean accessCheckEnabled) {
    this.conn = conn;
  ...
  public static class SystemTaskParamsBuilder {
    ...
    public SystemTaskParamsBuilder setAccessCheckEnabled(boolean accessCheckEnabled) {
      this.accessCheckEnabled = accessCheckEnabled;
      return this;
    }

    public SystemTaskParams build() {
      return new SystemTaskParams(conn, taskType, tenantId, schemaName, tableName, taskStatus, data,
        priority, startTs, endTs, accessCheckEnabled);
    }
  }
}
