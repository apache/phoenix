...
public class PUnsignedDate extends PDataType<Date> {
  ...
  private PUnsignedDate() {
    super("UNSIGNED_DATE", 19, Date.class, new UnsignedDateCodec(), 14); // After TIMESTAMP and DATE
                                                                         // to ensure toLiteral
                                                                         // finds those first
  }
  ...
  public boolean isCoercibleTo(PDataType targetType, Object value) {
    return super.isCoercibleTo(targetType, value)
      || PDate.INSTANCE.isCoercibleTo(targetType, value);
  }
  ...
  public boolean isBytesComparableWith(PDataType otherType) {
    return super.isBytesComparableWith(otherType) || otherType == PUnsignedTime.INSTANCE
      || otherType == PUnsignedTimestamp.INSTANCE || otherType == PUnsignedLong.INSTANCE;
  }
