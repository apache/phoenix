...
/**
 * Exception thrown when the size of the hash cache exceeds the maximum size as specified by the
 * phoenix.query.maxHashCacheBytes parameter in the {@link org.apache.hadoop.conf.Configuration}
 * @since 0.1
 */
