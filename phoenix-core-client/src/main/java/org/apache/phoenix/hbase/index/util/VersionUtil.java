...
public class VersionUtil {
  ...
  public static int encodeVersion(String version) {
    ...
    return VersionUtil.encodeVersion(versionParts[0],
  ...
  public static int encodeVersion(String major, String minor, String patch) {
    return encodeVersion(major == null ? 0 : Integer.parseInt(major),
      minor == null ? 0 : Integer.parseInt(minor), patch == null ? 0 : Integer.parseInt(patch));
  }
