...
public class StatelessTraverseAllParseNodeVisitor extends TraverseAllParseNodeVisitor<Void> {
  ...
  @Override
  public Void visitLeave(ArrayAllComparisonNode node, List<Void> l) throws SQLException {
    return null;
  }

  @Override
  public Void visitLeave(ArrayAnyComparisonNode node, List<Void> l) throws SQLException {
    return null;
  }

  @Override
  public Void visitLeave(ArrayElemRefNode node, List<Void> l) throws SQLException {
    return null;
  }
}
