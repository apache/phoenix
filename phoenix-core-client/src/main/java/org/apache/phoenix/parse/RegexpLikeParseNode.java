...
/**
 * Parse node corresponding to {@link RegexpLikeFunction}. It also acts as a factory for creating
...
public class RegexpLikeParseNode extends FunctionParseNode {
  ...
  RegexpLikeParseNode(String name, List<ParseNode> children, BuiltInFunctionInfo info) {
