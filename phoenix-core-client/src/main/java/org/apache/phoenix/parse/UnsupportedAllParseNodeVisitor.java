...
/**
 * Visitor that throws UnsupportedOperationException for every node. Meant to be sub-classed for the
 * case of a small subset of nodes being supported, in which case only those applicable methods
 * would be overridden.
 * @since 0.1
 */
