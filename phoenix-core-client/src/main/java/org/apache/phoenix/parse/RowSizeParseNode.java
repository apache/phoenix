...
public class RowSizeParseNode extends FunctionParseNode {
  ...
  RowSizeParseNode(String name, List<ParseNode> children, BuiltInFunctionInfo info) {
  ...
  public FunctionExpression create(List<Expression> children, StatementContext context)
    ...
    if (children.size() != 0) {
      throw new IllegalArgumentException("RowSizeFunction does not take any parameters");
    }
