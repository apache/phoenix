...
/**
 * Parse node corresponding to {@link CeilFunction}. It also acts as a factory for creating the
 * right kind of ceil expression according to the data type of the first child.
 * @since 3.0.0
 */
public class CeilParseNode extends FunctionParseNode {
  ...
  /**
   * When ceiling off decimals, user need not specify the scale. In such cases, we need to prevent
