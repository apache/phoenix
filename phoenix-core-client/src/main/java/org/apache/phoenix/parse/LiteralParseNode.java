...
public class LiteralParseNode extends TerminalParseNode {
  public static final List<ParseNode> STAR =
    Collections.<ParseNode> singletonList(new LiteralParseNode(1));
  ...
  public static final ParseNode MIN_LONG_AS_BIG_DECIMAL =
    new LiteralParseNode(BigDecimal.valueOf(Long.MIN_VALUE).abs());
  // See ParseNodeFactory.negate(), as MIN_LONG_AS_BIG_DECIMAL will be converted MIN_LONG if
  // negated.
