...
public interface MetricsMetadataCachingSource extends BaseSource {
  ...
  String METADATA_CACHE_INVALIDATION_OPERATIONS_DESC =
    "Number of times we invoke " + "cache invalidation within a DDL operation";
  ...
  String METADATA_CACHE_INVALIDATION_RPC_TIME_DESC =
    "Histogram for the time in milliseconds for" + " cache invalidation RPC";
  ...
  String METADATA_CACHE_INVALIDATION_TOTAL_TIME_DESC =
    "Histogram for the total time in milliseconds " + "for cache invalidation on all regionservers";
