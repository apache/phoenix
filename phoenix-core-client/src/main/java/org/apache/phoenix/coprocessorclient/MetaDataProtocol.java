...
public abstract class MetaDataProtocol extends MetaDataService {
  ...
  public static final long MIN_SYSTEM_TABLE_TIMESTAMP_5_4_0 = MIN_TABLE_TIMESTAMP + 51;
          ...
          for (SharedTableState sharedTableState : result.sharedTablesToDelete) {
            ...
            if (sharedTableState.getTenantId() != null) {
              sharedTableStateBuilder
                .setTenantId(ByteStringer.wrap(sharedTableState.getTenantId().getBytes()));
            }
            sharedTableStateBuilder
              .setSchemaName(ByteStringer.wrap(sharedTableState.getSchemaName().getBytes()));
            sharedTableStateBuilder
              .setTableName(ByteStringer.wrap(sharedTableState.getTableName().getBytes()));
