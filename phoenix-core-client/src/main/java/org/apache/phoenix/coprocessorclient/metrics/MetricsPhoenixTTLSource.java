...
public interface MetricsPhoenixTTLSource extends BaseSource {
  ...
  String PHOENIX_TTL_MASK_EXPIRED_REQUESTS_DESC =
    "The number of scan requests to mask PHOENIX TTL expired rows";

  String PHOENIX_TTL_DELETE_EXPIRED_REQUESTS = "phoenixDeleteTTLExpiredRequests";
  String PHOENIX_TTL_DELETE_EXPIRED_REQUESTS_DESC =
    "The number of delete requests to delete PHOENIX TTL expired rows";
