...
public class LogFileRecord implements LogFile.Record {
    ...
    /**
     * The Phoenix concept of HBase mutation type, which is currently a 1:1 mapping with HBase's,
     * with different code values (they don't need to match), but may potentially diverge in the
     * future.
     */
