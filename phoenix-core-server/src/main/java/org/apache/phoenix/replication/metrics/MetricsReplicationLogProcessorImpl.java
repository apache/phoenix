...
public class MetricsReplicationLogProcessorImpl extends BaseSourceImpl
  ...
  public MetricsReplicationLogProcessorImpl(String metricsName, String metricsDescription,
    ...
    failedMutationsCount =
      getMetricsRegistry().newCounter(FAILED_MUTATIONS_COUNT, FAILED_MUTATIONS_COUNT_DESC, 0L);
    failedBatchCount =
      getMetricsRegistry().newCounter(FAILED_BATCH_COUNT, FAILED_BATCH_COUNT_DESC, 0L);
