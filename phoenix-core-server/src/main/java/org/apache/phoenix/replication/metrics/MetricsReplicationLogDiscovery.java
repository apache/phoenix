...
public interface MetricsReplicationLogDiscovery extends BaseSource {
  ...
  /**
   * Increments the counter for in progress directory processing. This counter tracks the number of
   * times the in progress directory is processed during replication log discovery.
   */
