...
public class MetricsReplicationLogDiscoveryImpl extends BaseSourceImpl
  ...
  public MetricsReplicationLogDiscoveryImpl(String metricsName, String metricsDescription,
    ...
    numRoundsProcessed =
      getMetricsRegistry().newCounter(NUM_ROUNDS_PROCESSED, NUM_ROUNDS_PROCESSED_DESC, 0L);
    numInProgressDirectoryProcessed = getMetricsRegistry().newCounter(
      NUM_IN_PROGRESS_DIRECTORY_PROCESSED, NUM_IN_PROGRESS_DIRECTORY_PROCESSED_DESC, 0L);
    timeToProcessNewFiles =
