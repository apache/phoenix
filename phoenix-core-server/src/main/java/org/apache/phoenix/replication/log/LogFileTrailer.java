...
public class LogFileTrailer implements LogFile.Trailer {
  ...
  public void readFixedFields(DataInput in) throws IOException {
    ...
    if (majorVersion > LogFileHeader.VERSION_MAJOR) {
      throw new InvalidLogTrailerException("Unsupported version. Got major=" + majorVersion
        + " minor=" + minorVersion + ", expected major=" + LogFileHeader.VERSION_MAJOR + " minor="
  ...
  public String toString() {
    return "LogFileTrailer [majorVersion=" + majorVersion + ", minorVersion=" + minorVersion
      + ", recordCount=" + recordCount + ", blockCount=" + blockCount + ", blocksStartOffset="
      + blocksStartOffset + ", trailerStartOffset=" + trailerStartOffset + "]";
  }
