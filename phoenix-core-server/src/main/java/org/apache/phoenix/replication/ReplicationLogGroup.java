...
public class ReplicationLogGroup {
  ...
  /**
   * Append a mutation to the replication log group. This operation is normally non-blocking unless
  ...
  /**
   * Ensure all previously appended records are durably persisted. This method blocks until the sync
