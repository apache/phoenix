...
/**
 * Reader for Phoenix Replication Log files. Manages reading the header, trailer, and iterating
 * through blocks and records via the LogFormatReader.
 */
public class LogFileReader implements LogFile.Reader {
  ...
  public String toString() {
    return "LogFileReader [readerContext=" + context + ", formatReader=" + reader + ", closed="
      + closed + "]";
  }
