...
public class LogFileReaderContext {
  ...
  public LogFileReaderContext(Configuration conf) {
    ...
    this.isValidateTrailer =
      conf.getBoolean(LOGFILE_VALIDATE_TRAILER, DEFAULT_LOGFILE_VALIDATE_TRAILER);
  ...
  public String toString() {
    return "LogFileReaderContext [filePath=" + path + ", fileSize=" + fileSize
      + ", isSkipCorruptBlocks=" + isSkipCorruptBlocks + ", isValidateTrailer=" + isValidateTrailer
      + ", codec=" + codec + ", blocksRead=" + blocksRead + ", recordsRead=" + recordsRead
