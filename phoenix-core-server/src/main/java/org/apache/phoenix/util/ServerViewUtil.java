...
public class ServerViewUtil extends ViewUtil {
  ...
  public static void dropChildViews(RegionCoprocessorEnvironment env, byte[] tenantIdBytes,
    ...
    try {
      childViewsResult = ViewUtil.findImmediateRelatedViews(hTable, tenantIdBytes, schemaName,
        tableOrViewName, PTable.LinkType.CHILD_TABLE, HConstants.LATEST_TIMESTAMP);
    } finally {
      hTable.close();
    }
