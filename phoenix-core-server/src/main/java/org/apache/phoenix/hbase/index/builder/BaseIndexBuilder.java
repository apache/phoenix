 ...
 * {@link NonTxIndexBuilder}) as there is a lot of work required to keep an index table up-to-date.
 */
public abstract class BaseIndexBuilder implements IndexBuilder {
  ...
  /**
   * Exposed for testing! codec to use for this instance of the builder
   */
