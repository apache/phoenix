...
/**
 * A tool for running MapReduce-based ingests of input data based on regex. Lists are converted into
 * typed ARRAYS.
 */
public class RegexBulkLoadTool extends AbstractBulkLoadTool {

  static final Option REGEX_OPT =
    new Option("r", "regex", true, "Input regex String, defaults is (.*)");
  static final Option ARRAY_DELIMITER_OPT =
    new Option("a", "array-delimiter", true, "Array element delimiter (optional), defaults is ','");
