...
public final class PhoenixConfigurationUtil {
  ...
  public static List<ColumnInfo> getUpsertColumnMetadataList(final Configuration configuration)
    ...
    try (PhoenixConnection connection =
      ConnectionUtil.getOutputConnection(configuration).unwrap(PhoenixConnection.class)) {
  ...
  public static List<ColumnInfo> getSelectColumnMetadataList(final Configuration configuration)
    ...
    try (PhoenixConnection connection =
      ConnectionUtil.getInputConnection(configuration, props).unwrap(PhoenixConnection.class)) {
  ...
  public static void setIsPartialTransform(final Configuration configuration,
    Boolean partialTransform) throws SQLException {
    Preconditions.checkNotNull(configuration);
