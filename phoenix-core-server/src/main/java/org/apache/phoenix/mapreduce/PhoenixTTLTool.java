...
public class PhoenixTTLTool extends Configured implements Tool {
  ...
  private static final Option DELETE_ALL_VIEWS_OPTION =
    new Option("a", "all", false, "Delete all views from all tables.");
  private static final Option VIEW_NAME_OPTION =
    new Option("v", "view", true, "Delete Phoenix View Name");
  private static final Option TENANT_ID_OPTION =
    new Option("i", "id", true, "Delete an view based on the tenant id.");
  ...
  private static final Option SPLIT_SIZE_OPTION =
    new Option("s", "split-size-per-mapper", true, "Define split size for each mapper.");
  ...
  private static final Option RUN_FOREGROUND_OPTION = new Option("runfg", "run-foreground", false,
    "If specified, runs PhoenixTTLTool " + "in Foreground. Default - Runs the build in background");
  ...
  public CommandLine parseOptions(String[] args) {
    ...
    if (
      !cmdLine.hasOption(DELETE_ALL_VIEWS_OPTION.getOpt())
