...
/**
 * Get index scrutiny source/target column names, depending on whether the source is the data table
 * or index table
 */
public interface SourceTargetColumnNames {
  ...
  /** Returns The target column name with a CAST to the source's data type */
