...
public class CsvToKeyValueMapper extends FormatToBytesWritableMapper<CSVRecord> {
  ...
  protected void setup(Context context) throws IOException, InterruptedException {
    ...
    lineParser = new CsvLineParser(CsvBulkImportUtil.getCharacter(conf, FIELD_DELIMITER_CONFKEY),
  ...
  protected UpsertExecutor<CSVRecord, ?> buildUpsertExecutor(Configuration conf) {
    ...
    String arraySeparator =
      conf.get(ARRAY_DELIMITER_CONFKEY, CSVCommonsLoader.DEFAULT_ARRAY_ELEMENT_SEPARATOR);
