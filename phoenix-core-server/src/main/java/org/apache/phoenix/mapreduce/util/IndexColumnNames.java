...
public class IndexColumnNames {
  ...
  /**
   * @return the escaped data column names (equivalents for the index columns) along with their sql
   *         type, for use in dynamic column queries/upserts
   */
  ...
  /**
   * @return the corresponding data table column names for the index columns, leading with the data
   *         table pk columns
   */
  ...
  /** Returns same as getDataColNames, without the column family qualifier */
  public List<String> getUnqualifiedDataColNames() {
    return getUnqualifiedColNames(dataColNames);
  }

  /**
   * @return the corresponding data table column names for the index columns, which are not part of
   *         the data table pk
   */
  ...
  /**
   * @return the corresponding data table column names for the index columns, which are part of the
   *         data table pk
   */
  ...
  /** Returns the index column names, leading with the data table pk columns */
  public List<String> getIndexColNames() {
    return indexColNames;
  }

  /** Returns same as getIndexColNames, without the column family qualifier */
  public List<String> getUnqualifiedIndexColNames() {
    return getUnqualifiedColNames(indexColNames);
  }

  /** Returns the index pk column names */
