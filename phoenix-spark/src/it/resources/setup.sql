...
CREATE TABLE SALTED_TABLE (ID BIGINT NOT NULL PRIMARY KEY, COL1 VARCHAR) SALT_BUCKETS = 20
UPSERT INTO SALTED_TABLE(ID,COL1) VALUES(1, 'FOO')
UPSERT INTO SALTED_TABLE(ID,COL1) VALUES(2, 'BAR')