 ...
 */
public class HiveTestContext {
    private boolean isHDFSCleanup;
    private Path resFile;
    private Path resDir;
    private FileSystem resFs;
    private static final Log LOG = LogFactory.getLog("HiveTestContext");
    ...
    public HiveTestContext(Configuration conf) throws IOException {
     ...
     */
    public HiveTestContext(Configuration conf, String executionId)  {
        this.conf = conf;
