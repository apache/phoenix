...
public class PhoenixStorageHandler extends DefaultStorageHandler implements
    ...
    private void configureJobProperties(TableDesc tableDesc, Map<String, String> jobProperties)
    {
      ...
      tblProps.getProperty(HiveConfigurationUtil.TABLE_NAME);
      ...
      jobProperties.put(PhoenixConfigurationUtil.SELECT_STATEMENT, "select * from " +jobProperties.get
              (HiveConfigurationUtil.TABLE_NAME));
      if((jobProperties.get(HiveConfigurationUtil.TABLE_NAME)).contains("limit")==true){
          
      }
      LOG.debug("ConfigurationUtil.SELECT_STATEMENT " +
              jobProperties.get(PhoenixConfigurationUtil.SELECT_STATEMENT));
    }
