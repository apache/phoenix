...
public class PhoenixUtil {
    static Log LOG = LogFactory.getLog(PhoenixUtil.class);
    ...
    public static boolean testTable(Connection conn, String name, Map<String, String> fields)
        ...
        if (PhoenixUtil.compareColumns(columns, fields)) {
            throw new MetaException("Row order mismatch between Hive and Phoenix tables phoenix cols "
                    + columns.toString()+" hive fields "+fields.toString());
        }
