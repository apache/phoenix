...
public class Column {
  ...
  /**
   * Changes fields of this object to match existing fields from the passed Column null object
   * members are ignored. Field type cannot be mutated.
   * @param column {@link Column} obj contains only the fields you want to mutate this object into.
   */
