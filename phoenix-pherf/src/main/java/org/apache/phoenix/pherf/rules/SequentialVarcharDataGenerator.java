...
public class SequentialVarcharDataGenerator implements RuleBasedDataGenerator {
  ...
  /**
   * Add a numerically increasing counter onto the and of a random string. Incremented counter
  ...
  public DataValue getDataValue() {
    ...
    String varchar = (columnRule.getPrefix() != null) ? columnRule.getPrefix() + strInc2 : strInc2;
