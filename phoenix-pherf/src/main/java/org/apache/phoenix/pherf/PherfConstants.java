...
public class PherfConstants {
    ...
    public static final String SCENARIO_ROOT_PATTERN = ".*" + PherfConstants.RESOURCE_SCENARIO.substring(1) + ".*";
    ...
    public static final String CSV_MONITOR_HEADER = "STAT_NAME,STAT_VALUE,TIME_STAMP";
    public static enum RunMode {PERFORMANCE, FUNCTIONAL};
}
