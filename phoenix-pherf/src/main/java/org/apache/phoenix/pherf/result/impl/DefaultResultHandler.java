...
public abstract class DefaultResultHandler implements ResultHandler {
   ...
   * setting the file name. Otherwise you will get a NPE. TODO Change this so NPE is not possible.
   * Needs a bit of refactoring here
   * @param resultFileName Base name of file
   */
  @Override
  public void setResultFileName(String resultFileName) {
    this.resultFileName = resultDir + PherfConstants.PATH_SEPARATOR + PherfConstants.RESULT_PREFIX
      + resultFileName + util.getSuffix() + getResultFileDetails().getExtension().toString();
  }
