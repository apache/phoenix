...
/**
 * A load generator that generates a uniform distribution of operations among the given tenant
 * group.
 */
public class UniformDistributionLoadEventGenerator extends BaseLoadEventGenerator {
  ...
  public UniformDistributionLoadEventGenerator(PhoenixUtil phoenixUtil, DataModel model,
    Scenario scenario, Properties properties) {
    super(phoenixUtil, model, scenario, properties);
    this.sampler =
      new UniformDistributionSampler(operationFactory.getOperations(), model, scenario);
  }
