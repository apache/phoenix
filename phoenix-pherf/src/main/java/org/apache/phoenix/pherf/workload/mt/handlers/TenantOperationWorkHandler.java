...
/**
 * A handler {@link WorkHandler} for executing the operations {@link Operation} as and when they
 * become available on the {@link com.lmax.disruptor.RingBuffer} when published by the workload
 * generator {@link MultiTenantWorkload}
 */
