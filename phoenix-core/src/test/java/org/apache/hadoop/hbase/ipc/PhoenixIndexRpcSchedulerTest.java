...
public class PhoenixIndexRpcSchedulerTest {
  ...
  public void testIndexPriorityWritesToIndexHandler() throws Exception {
    ...
    PhoenixRpcScheduler scheduler =
      new PhoenixRpcScheduler(conf, mock, 200, 250, 225, qosFunction, abortable);
  ...
  public void testServerSideRPCalls() throws Exception {
    ...
    PhoenixRpcScheduler scheduler1 =
      new PhoenixRpcScheduler(conf, mock, 200, 250, 100, qosFunction, abortable);
    ...
    PhoenixRpcScheduler scheduler2 =
      new PhoenixRpcScheduler(conf, mock, 101, 110, 50, qosFunction, abortable);
