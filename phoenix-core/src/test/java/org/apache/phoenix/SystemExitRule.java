...
/**
 * Test rule that prevents System.exit / JVM exit to error out the test runner, which manages JVM
 * and providing test output files, and instead throw valid Exception to handle JVM exit gracefully
 */
