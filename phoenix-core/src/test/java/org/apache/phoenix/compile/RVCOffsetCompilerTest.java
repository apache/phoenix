...
public class RVCOffsetCompilerTest {
  ...
  public void buildListOfColumnParseNodesTest() throws Exception {
    ...
    List<ColumnParseNode> result = offsetCompiler.buildListOfColumnParseNodes(rvc, true);
  ...
  public void buildListOfRowKeyColumnExpressionsIndexTest() throws Exception {
    ...
    PColumn column = new PColumnImpl(PName.EMPTY_COLUMN_NAME, PName.EMPTY_NAME, PDecimal.INSTANCE,
      10, 1, true, 1, SortOrder.getDefault(), 0, null, false, null, false, false, null,
