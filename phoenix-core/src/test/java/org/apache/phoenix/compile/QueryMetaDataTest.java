...
public class QueryMetaDataTest extends BaseConnectionlessQueryTest {
  ...
  public void testParameterMetaData() throws Exception {
    String query =
      "SELECT a_string, b_string FROM atable WHERE organization_id=? and (a_integer = ? or a_date = ? or b_string = ? or a_string = 'foo')";
    Connection conn =
      DriverManager.getConnection(getUrl(), PropertiesUtil.deepCopy(TestUtil.TEST_PROPERTIES));
    PreparedStatement statement = conn.prepareStatement(query);
    ParameterMetaData pmd = statement.getParameterMetaData();
  ...
  public void testLimitParameterMetaData() throws Exception {
    String query =
      "SELECT a_string, b_string FROM atable WHERE organization_id=? and a_string = 'foo' LIMIT ?";
    Connection conn =
      DriverManager.getConnection(getUrl(), PropertiesUtil.deepCopy(TestUtil.TEST_PROPERTIES));
    PreparedStatement statement = conn.prepareStatement(query);
    ParameterMetaData pmd = statement.getParameterMetaData();
  ...
  public void testCaseMetaData() throws Exception {
    String query1 =
      "SELECT a_string, b_string FROM atable WHERE case when a_integer = 1 then ? when a_integer > 2 then 2 end > 3";
    Connection conn =
      DriverManager.getConnection(getUrl(), PropertiesUtil.deepCopy(TestUtil.TEST_PROPERTIES));
    ...
    String query2 =
      "SELECT a_string, b_string FROM atable WHERE case when a_integer = 1 then 1 when a_integer > 2 then 2 end > ?";
  ...
  public void testKeyPrefixParameterMetaData() throws Exception {
    String query =
      "SELECT a_string, b_string FROM atable WHERE organization_id='000000000000000' and substr(entity_id,1,3)=? and a_string = 'foo'";
    Connection conn =
      DriverManager.getConnection(getUrl(), PropertiesUtil.deepCopy(TestUtil.TEST_PROPERTIES));
    PreparedStatement statement = conn.prepareStatement(query);
    ParameterMetaData pmd = statement.getParameterMetaData();
  ...
  public void testCoerceToDecimalArithmeticMetaData() throws Exception {
    ...
    for (String op : ops) {
      String query =
        "SELECT entity_id,a_string FROM atable where a_integer" + op + "2.5" + op + "?=0";
      Connection conn =
        DriverManager.getConnection(getUrl(), PropertiesUtil.deepCopy(TestUtil.TEST_PROPERTIES));
      PreparedStatement statement = conn.prepareStatement(query);
  ...
  public void testLongArithmeticMetaData() throws Exception {
    ...
    for (String op : ops) {
      String query =
        "SELECT entity_id,a_string FROM atable where a_integer" + op + "2" + op + "?=0";
      Connection conn =
        DriverManager.getConnection(getUrl(), PropertiesUtil.deepCopy(TestUtil.TEST_PROPERTIES));
      PreparedStatement statement = conn.prepareStatement(query);
      statement.setInt(1, 4);
  ...
  public void testBasicResultSetMetaData() throws Exception {
    String query =
      "SELECT organization_id, a_string, b_string, a_integer i, a_date FROM atable WHERE organization_id='000000000000000' and substr(entity_id,1,3)=? and a_string = 'foo'";
    Connection conn =
      DriverManager.getConnection(getUrl(), PropertiesUtil.deepCopy(TestUtil.TEST_PROPERTIES));
    PreparedStatement statement = conn.prepareStatement(query);
  ...
  public void testRowValueConstructorBindParamMetaData() throws Exception {
    String query =
      "SELECT a_integer, x_integer FROM aTable WHERE (a_integer, x_integer, a_string) = (?, ?, ?)";
    Connection conn =
      DriverManager.getConnection(getUrl(), PropertiesUtil.deepCopy(TestUtil.TEST_PROPERTIES));
    PreparedStatement statement = conn.prepareStatement(query);
    ParameterMetaData pmd = statement.getParameterMetaData();
  ...
  public void testRowValueConstructorBindParamMetaDataWithMoreNumberOfBindArgs() throws Exception {
    String query =
      "SELECT a_integer, x_integer FROM aTable WHERE (a_integer, x_integer) = (?, ?, ?)";
    Connection conn =
      DriverManager.getConnection(getUrl(), PropertiesUtil.deepCopy(TestUtil.TEST_PROPERTIES));
    PreparedStatement statement = conn.prepareStatement(query);
    ParameterMetaData pmd = statement.getParameterMetaData();
  ...
  @Test
  public void testRowValueConstructorBindParamMetaDataWithBindArgsAtDiffPlacesOnLHSRHS()
    throws Exception {
    String query = "SELECT a_integer, x_integer FROM aTable WHERE (a_integer, ?) = (?, a_integer)";
    Connection conn =
      DriverManager.getConnection(getUrl(), PropertiesUtil.deepCopy(TestUtil.TEST_PROPERTIES));
