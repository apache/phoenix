...
public class TenantSpecificViewIndexTest extends BaseHBaseManagedTimeTest {
    @Test
    public void testUpdatableView() throws Exception {
        Connection conn = DriverManager.getConnection(getUrl());
        String ddl = "CREATE TABLE t (t_id VARCHAR NOT NULL, k1 INTEGER NOT NULL, k2 INTEGER NOT NULL, v1 VARCHAR, CONSTRAINT pk PRIMARY KEY (t_id, k1, k2)) multi_tenant=true";
        ...
        assertEquals("CLIENT PARALLEL 1-WAY RANGE SCAN OVER I ['me',-32768,'v2-1']", QueryUtil.getExplainPlan(rs));
    }
