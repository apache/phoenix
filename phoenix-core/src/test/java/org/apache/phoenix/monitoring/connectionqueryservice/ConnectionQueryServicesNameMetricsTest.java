...
/**
 * This class is used primarily to populate data and verification methods
 */
...
public class ConnectionQueryServicesNameMetricsTest {
  ...
  public void populateMetrics() {
    ...
    for (int i = 0; i < connectionQueryServiceNames.length; i++) {
      ...
      metrics.put(OPEN_INTERNAL_PHOENIX_CONNECTIONS_COUNTER, openInternalPhoenixConnCounter[i]);
