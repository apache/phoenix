    ...
    public void testVariousViews() {
        try {
            ...
            assertRowKeyPrefixesForTable(
                    ...
                    SchemaUtil.getSchemaNameFromFullName(tableName),
                    SchemaUtil.getTableNameFromFullName(tableName));
            tableName = createViewHierarchy(testCases, sortOrders, 200,2000,3,true, false, false);
            assertRowKeyPrefixesForTable(
                    getUrl(),
                    SchemaUtil.getSchemaNameFromFullName(tableName),
                    SchemaUtil.getTableNameFromFullName(tableName));
            tableName = createViewHierarchy(testCases, sortOrders, 300,3000,3,false, true, false);
            assertRowKeyPrefixesForTable(
                    getUrl(),
                    SchemaUtil.getSchemaNameFromFullName(tableName),
                    SchemaUtil.getTableNameFromFullName(tableName));
            tableName = createViewHierarchy(testCases, sortOrders, 400,4000,3,false, false, false);
            assertRowKeyPrefixesForTable(
                    getUrl(),
                    SchemaUtil.getSchemaNameFromFullName(tableName),
                    SchemaUtil.getTableNameFromFullName(tableName));
            tableName = createViewHierarchy(testCases, sortOrders, 500,5000,3,true, false, true);
            assertRowKeyPrefixesForTable(
                    getUrl(),
                    SchemaUtil.getSchemaNameFromFullName(tableName),
                    SchemaUtil.getTableNameFromFullName(tableName));
            tableName = createViewHierarchy(testCases, sortOrders, 600,6000,3,true, false, true);
            assertRowKeyPrefixesForTable(
                    getUrl(),
                    SchemaUtil.getSchemaNameFromFullName(tableName),
                    SchemaUtil.getTableNameFromFullName(tableName));
            tableName = createViewHierarchy(testCases, sortOrders, 700,7000,3,false, false, true);
            assertRowKeyPrefixesForTable(
                    getUrl(),
                    SchemaUtil.getSchemaNameFromFullName(tableName),
                    SchemaUtil.getTableNameFromFullName(tableName));
            tableName = createViewHierarchy(testCases, sortOrders, 800,8000,3,false, false, true);
            assertRowKeyPrefixesForTable(
                    getUrl(),
                    SchemaUtil.getSchemaNameFromFullName(tableName),
                    SchemaUtil.getTableNameFromFullName(tableName));
