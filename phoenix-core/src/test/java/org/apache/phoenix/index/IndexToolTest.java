...
public class IndexToolTest extends BaseTest {
  ...
  public void testParseOptions_timeRange_timeRangeNotNull() throws Exception {
    ...
    Long startTime = 10L;
    Long endTime = 15L;
    String[] args = IndexToolIT.getArgValues(true, schema, dataTable, indexTable, tenantId,
  ...
  public void testParseOptions_timeRange_startTimeNotNull() throws Exception {
    ...
    Long startTime = 10L;
    String[] args = IndexToolIT.getArgValues(true, schema, dataTable, indexTable, tenantId,
      IndexTool.IndexVerifyType.NONE, startTime, null);
    CommandLine cmdLine = it.parseOptions(args);
    it.populateIndexToolAttributes(cmdLine);
    assertEquals(startTime, it.getStartTime());
  ...
  public void testParseOptions_timeRange_endTimeNotNull() throws Exception {
    Long endTime = 15L;
    String[] args = IndexToolIT.getArgValues(true, schema, dataTable, indexTable, tenantId,
      IndexTool.IndexVerifyType.NONE, null, endTime);
    CommandLine cmdLine = it.parseOptions(args);
    it.populateIndexToolAttributes(cmdLine);
  ...
  public void testIncrcementalVerifyOption() throws Exception {
    ...
    String[] args = IndexToolIT.getArgValues(true, schema, dataTable, indexTable, tenantId,
      IndexTool.IndexVerifyType.NONE, lastVerifyTime, null, IndexTool.IndexDisableLoggingType.NONE,
      lastVerifyTime);
  ...
  public void testIncrcementalVerifyOption_notApplicable() throws Exception {
    ...
    Long lastVerifyTime = 10L;
    String[] args = IndexToolIT.getArgValues(true, schema, dataTable, indexTable, tenantId,
      IndexTool.IndexVerifyType.AFTER, lastVerifyTime, null, IndexTool.IndexDisableLoggingType.NONE,
      lastVerifyTime);
    when(mockTool.parseOptions(args)).thenCallRealMethod();
  ...
  public void testIncrementalVerifyNotSupportedWithoutRawSkipScanFilters() {
    ...
    try {
      ...
      Long lastVerifyTime = 10L;
      String[] args = IndexToolIT.getArgValues(true, schema, dataTable, indexTable, tenantId,
        IndexTool.IndexVerifyType.AFTER, lastVerifyTime, null,
        IndexTool.IndexDisableLoggingType.NONE, lastVerifyTime);
    ...
    try {
      ...
      Long lastVerifyTime = 10L;
      String[] args = IndexToolIT.getArgValues(true, schema, dataTable, indexTable, tenantId,
        IndexTool.IndexVerifyType.AFTER, null, null, IndexTool.IndexDisableLoggingType.NONE,
        lastVerifyTime);
      it.parseOptions(args);
      Assert.fail("Should have thrown an IllegalStateException");
    } catch (IllegalStateException ise) {
  ...
  public void testDisableLogging_allowsBefore() throws Exception {
    verifyDisableLogging(IndexTool.IndexDisableLoggingType.BEFORE,
  ...
  public void verifyDisableLogging(IndexTool.IndexDisableLoggingType disableType,
    ...
    Long endTime = 10L;
    String[] args = IndexToolIT.getArgValues(true, schema, dataTable, indexTable, tenantId,
      verifyType, startTime, endTime, disableType, null);
    CommandLine cmdLine = it.parseOptions(args);
    it.populateIndexToolAttributes(cmdLine);
  ...
  private void verifyFromIndexOption(IndexTool.IndexVerifyType verifyType) throws Exception {
    Long startTime = 1L;
    Long endTime = 10L;
    String[] args = IndexToolIT.getArgValues(true, true, schema, dataTable, indexTable, tenantId,
      verifyType, startTime, endTime, IndexTool.IndexDisableLoggingType.BEFORE, null, true);
    CommandLine cmdLine = it.parseOptions(args);
    it.populateIndexToolAttributes(cmdLine);
