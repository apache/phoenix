...
public class PrepareIndexMutationsForRebuildTest extends BaseConnectionlessQueryTest {
  ...
  public void testPutDeleteOnSameTimeStampAndPutNullifiedByDelete() throws Exception {
    ...
    Delete dataDel = new Delete(Bytes.toBytes(ROW_KEY));
    addCellToDelMutation(dataDel, Bytes.toBytes("CF1"), null, 2, KeyValue.Type.DeleteFamily);
  ...
  public void testPutDeleteOnSameTimeStampAndPutAndOldPutAllNullifiedByDelete() throws Exception {
    ...
    Delete dataDel = new Delete(Bytes.toBytes(ROW_KEY));
    addCellToDelMutation(dataDel, Bytes.toBytes("CF2"), null, 2, KeyValue.Type.DeleteFamily);
  ...
  public void testForMultipleFamilies() throws Exception {
    ...
    Delete idxDel = new Delete(idxKeyBytes);
    addCellToDelMutation(idxDel, Bytes.toBytes("CF2"), null, 2, KeyValue.Type.DeleteFamily);
    expectedIndexMutation.add(idxDel);
  ...
  void addCellToDelMutation(Delete del, byte[] family, byte[] column, long ts, KeyValue.Type type)
    throws Exception {
  ...
  boolean isEqualCell(Cell a, Cell b) {
    return CellUtil.matchingRow(a, b) && CellUtil.matchingFamily(a, b)
      && CellUtil.matchingQualifier(a, b) && CellUtil.matchingTimestamp(a, b)
      && CellUtil.matchingType(a, b) && CellUtil.matchingValue(a, b);
  }
}
