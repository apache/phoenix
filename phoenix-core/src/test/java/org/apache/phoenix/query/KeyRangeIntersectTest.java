...
public class KeyRangeIntersectTest extends TestCase {
  ...
  public static synchronized Collection<?> data() {
    return Arrays.asList(new Object[][] {
      ...
      { EMPTY_RANGE, EVERYTHING_RANGE, EMPTY_RANGE },
      { EMPTY_RANGE,
        PChar.INSTANCE.getKeyRange(toBytes("E"), false, toBytes("F"), true, SortOrder.ASC),
        EMPTY_RANGE },
      { PDate.INSTANCE.getKeyRange(PDate.INSTANCE.toBytes(DateUtil.parseDate("2011-01-01")), true,
        PDate.INSTANCE.toBytes(DateUtil.parseDate("2016-01-01")), true, SortOrder.ASC),
        PDate.INSTANCE.getKeyRange(PDate.INSTANCE.toBytes(DateUtil.parseDate("2012-10-21")), false,
          PDate.INSTANCE.toBytes(DateUtil.parseDate("2016-10-31")), false, SortOrder.ASC),
        PDate.INSTANCE.getKeyRange(PDate.INSTANCE.toBytes(DateUtil.parseDate("2012-10-21")), false,
          PDate.INSTANCE.toBytes(DateUtil.parseDate("2016-01-01")), true, SortOrder.ASC) } });
  }
