...
public class RecoverLeaseFSUtilsTest extends ParallelStatsDisabledIT {
  ...
  public void testRecoverLease() throws IOException {
    ...
    assertTrue((EnvironmentEdgeManager.currentTime() - startTime) > (3 * conf.getLong(
      RecoverLeaseFSUtils.REPLICATION_REPLAY_LEASE_RECOVERY_DFS_TIMEOUT_MILLISECOND, 61000)));
  }
