...
public class PDataTypeTest {
  ...
  public void testCoercibleGoldfile() {
    ...
    assertEquals("{BIGINT=[BIGINT, BINARY, DECIMAL, DOUBLE, VARBINARY], "
      ...
      + "BINARY=[BINARY, VARBINARY], " + "BINARY ARRAY=[BINARY ARRAY, VARBINARY ARRAY], "
      ...
      + "DECIMAL=[DECIMAL, VARBINARY], " + "DECIMAL ARRAY=[DECIMAL ARRAY, VARBINARY ARRAY], "
      ...
      + "VARBINARY=[BINARY, VARBINARY], " + "VARBINARY ARRAY=[BINARY ARRAY, VARBINARY ARRAY], "
