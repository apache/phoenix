...
public class PCharPadTest {
  ...
  public void test(String value, PDataType dataType, int length, SortOrder sortOrder, byte[] result)
    throws SQLException {
  ...
  public void testCharPaddingAsc4() throws SQLException {
    ...
    byte[] result =
      new byte[] { 104, 101, 108, 108, 111, 32, 119, 111, 114, 108, 100, 32, 32, 32, 32, 32 };
  ...
  public void testCharPaddingDesc2() throws SQLException {
    PDataType dataType = PChar.INSTANCE;
    String str = "phoenix";
    byte[] result = new byte[] { -113, -105, -112, -102, -111, -106, -121, -33, -33, -33, -33, -33,
      -33, -33, -33 };
  ...
  public void testCharPaddingDesc4() throws SQLException {
    PDataType dataType = PChar.INSTANCE;
    String str = "hello world";
    byte[] result = new byte[] { -105, -102, -109, -109, -112, -33, -120, -112, -115, -109, -101,
      -33, -33, -33, -33, -33 };
