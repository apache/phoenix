...
public class ImmutableStorageSchemeTest {
  ...
  protected Expression FALSE_EVAL_EXPRESSION =
    new DelegateExpression(LiteralExpression.newConstant(null)) {
      @Override
  ...
  @Parameters(
      name = "ImmutableStorageSchemeTest_immutableStorageScheme={0},serializationVersion={1}}") // name
                                                                                                // is
                                                                                                // used
                                                                                                // by
                                                                                                // failsafe
  ...
  public static synchronized List<Object[]> data() {
    return Arrays
      .asList(new Object[][] { { SINGLE_CELL_ARRAY_WITH_OFFSETS, IMMUTABLE_SERIALIZATION_VERSION },
        { SINGLE_CELL_ARRAY_WITH_OFFSETS, IMMUTABLE_SERIALIZATION_V2 } });
  }
  ...
  public void testLeadingNulls() throws Exception {
    ...
    assertDecodedContents(ptr,
      new byte[][] { EMPTY_BYTE_ARRAY, EMPTY_BYTE_ARRAY, BYTE_ARRAY1, BYTE_ARRAY2 });
  }
  ...
  public void testTrailingNulls() throws Exception {
    ...
    assertDecodedContents(ptr,
      new byte[][] { BYTE_ARRAY1, BYTE_ARRAY2, EMPTY_BYTE_ARRAY, EMPTY_BYTE_ARRAY });
  }
  ...
  public void testSingleLeadingTrailingNull() throws Exception {
    ...
    assertDecodedContents(ptr, new byte[][] { EMPTY_BYTE_ARRAY, BYTE_ARRAY1, EMPTY_BYTE_ARRAY });
  }
  ...
  public void testAllShortValues() throws Exception {
    ...
    while (curr <= Short.MAX_VALUE) {
      ...
      if (ptr.getLength() == 0) {
        ...
        if (
          curr != PSmallint.INSTANCE.getCodec().decodeShort(ptr.copyBytesIfNecessary(), 0,
            SortOrder.ASC)
        ) {
          failedValues.add(curr);
        }
