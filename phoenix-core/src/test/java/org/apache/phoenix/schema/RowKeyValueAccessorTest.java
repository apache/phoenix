...
public class RowKeyValueAccessorTest extends BaseConnectionlessQueryTest {
  ...
  private void assertExpectedRowKeyValue(String dataColumns, String pk, Object[] values, int index)
    throws Exception {
    assertExpectedRowKeyValue(dataColumns, pk, values, index, "");
  }

  private void assertExpectedRowKeyValue(String dataColumns, String pk, Object[] values, int index,
    String dataProps) throws Exception {
    String schemaName = "";
    String tableName = "T";
    ...
    dataType.coerceBytes(ptr, dataType, pkColumns.get(index).getSortOrder(),
  ...
  public void testFixedLengthValueAtEnd() throws Exception {
    assertExpectedRowKeyValue(
      ...
      "n,s,y DESC,o DESC", new Object[] { "Abbey", "F", 2012, 253 }, 3);
  }
}
