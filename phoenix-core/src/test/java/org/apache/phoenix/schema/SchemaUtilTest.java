...
public class SchemaUtilTest {
  ...
  public void testExceptionCode() throws Exception {
    SQLExceptionCode code =
      SQLExceptionCode.fromErrorCode(SQLExceptionCode.AGGREGATE_IN_GROUP_BY.getErrorCode());
  ...
  public void testGetTableNameFromFullNameByte() {
    String tableDisplayName =
      SchemaUtil.getTableNameFromFullName(Bytes.toBytes("schemaName.tableName"));
    assertEquals(tableDisplayName, "tableName");
  }
