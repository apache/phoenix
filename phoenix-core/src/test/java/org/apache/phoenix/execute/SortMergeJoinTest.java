...
public class SortMergeJoinTest {
  ...
  @Test
  public void testOptimizeSemiJoinForSortMergeJoinBug5956()
    ...
    Pair<List<OrderByNode>, List<OrderByNode>> lhsAndRhsOrderByNodes = Pair.<List<OrderByNode>,
      List<OrderByNode>> newPair(new ArrayList<OrderByNode>(), new ArrayList<OrderByNode>());
    ...
    when(lhsQueryPlan.iterator(DefaultParallelScanGrouper.getInstance()))
      .thenReturn(lhsResultIterator);
    ...
    when(rhsQueryPlan.iterator(DefaultParallelScanGrouper.getInstance()))
      .thenReturn(rhsResultIterator);

    SortMergeJoinPlan sortMergeJoinPlan =
      new SortMergeJoinPlan(statementContext, null, null, joinType, lhsQueryPlan, rhsQueryPlan,
        lhsAndRhsJoinExpressions, expressions, null, null, null, 0, true, lhsAndRhsOrderByNodes);
