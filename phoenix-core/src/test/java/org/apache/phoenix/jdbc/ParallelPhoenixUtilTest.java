...
public class ParallelPhoenixUtilTest {
  ...
  private static final ParallelPhoenixContext context = new ParallelPhoenixContext(new Properties(),
    null, HighAvailabilityTestingUtility.getListOfSingleThreadExecutorServices(), null);
  ...
  public void getAnyOfNonExceptionallyTimeoutTest() throws Exception {
    ...
    ParallelPhoenixContext ctx = new ParallelPhoenixContext(props, null,
