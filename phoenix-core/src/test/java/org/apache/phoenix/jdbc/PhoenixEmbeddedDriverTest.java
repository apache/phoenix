...
public class PhoenixEmbeddedDriverTest {
  ...
  public void testGetZKConnectionInfo() throws SQLException {
    ...
    for (String protocol : new String[] { "phoenix", "phoenix+zk" }) {
      String[] urls = new String[] { null, "", "jdbc:" + protocol + "",
        "jdbc:" + protocol + ";test=true", "jdbc:" + protocol + ":localhost", "localhost",
        "localhost;", "jdbc:" + protocol + ":localhost:123",
        "jdbc:" + protocol + ":localhost:123;foo=bar", "localhost:123",
        "jdbc:" + protocol + ":localhost:123:/hbase",
        "jdbc:" + protocol + ":localhost:123:/foo-bar",
        "jdbc:" + protocol + ":localhost:123:/foo-bar;foo=bas", "localhost:123:/foo-bar",
        "jdbc:" + protocol + ":localhost:/hbase", "jdbc:" + protocol + ":localhost:/foo-bar",
        "jdbc:" + protocol + ":localhost:/foo-bar;test=true", "localhost:/foo-bar",
        "jdbc:" + protocol + ":v1,v2,v3", "jdbc:" + protocol + ":v1,v2,v3;",
        "jdbc:" + protocol + ":v1,v2,v3;test=true", "v1,v2,v3",
        "jdbc:" + protocol + ":v1,v2,v3:/hbase", "jdbc:" + protocol + ":v1,v2,v3:/hbase;test=true",
        "v1,v2,v3:/foo-bar", "jdbc:" + protocol + ":v1,v2,v3:123:/hbase", "v1,v2,v3:123:/hbase",
        ...
        "jdbc:" + protocol + ":localhost:1234:user:C:\\user.keytab", "jdbc:" + protocol
          + ":v1,v2,v3:345:/hbase:user1:C:\\Documents and Settings\\user1\\user1.keytab;test=false", };
      String[][] partsList = new String[][] { { defaultQuorum + ":2181", null, "/hbase" },
        { defaultQuorum + ":2181", null, "/hbase" }, { defaultQuorum + ":2181", null, "/hbase" },
        {}, { "localhost:2181", null, "/hbase" }, { "localhost:2181", null, "/hbase" },
        { "localhost:2181", null, "/hbase" }, { "localhost:123", null, "/hbase" },
        { "localhost:123", null, "/hbase" }, { "localhost:123", null, "/hbase" },
        { "localhost:123", null, "/hbase" }, { "localhost:123", null, "/foo-bar" },
        { "localhost:123", null, "/foo-bar" }, { "localhost:123", null, "/foo-bar" },
        { "localhost:2181", null, "/hbase" }, { "localhost:2181", null, "/foo-bar" },
        { "localhost:2181", null, "/foo-bar" }, { "localhost:2181", null, "/foo-bar" },
        ...
        { "v1:2181,v2:2181,v3:2181", null, "/hbase" },
        { "v1:2181,v2:2181,v3:2181", null, "/hbase" },
        { "v1:2181,v2:2181,v3:2181", null, "/foo-bar" }, { "v1:123,v2:123,v3:123", null, "/hbase" },
        { "v1:123,v2:123,v3:123", null, "/hbase" }, { "v1:123,v2:123,v3:123", null, "/hbase" },
        { "v1:123,v2:123,v3:123", null, "/hbase", "user/principal", "/user.keytab" },
        { "v1:123,v2:123,v3:123", null, "/foo-bar", "user/principal", "/user.keytab" },
        { "v1:123,v2:123,v3:123", null, "/hbase", "user/principal", "/user.keytab" },
        { "v1:2181,v2:2181,v3:2181", null, "/hbase", "user/principal", "/user.keytab" },
        { "v1:2181,v2:2181,v3:2181", null, "/hbase", "user/principal", "/user.keytab" },
        { "v1:2181,v2:2181,v3:2181", null, "/hbase", "LongRunningQueries" },
        { "v1:345,v2:345,v3:345", null, "/hbase", "LongRunningQueries" },
        { "localhost:1234", null, "/hbase", "user", "C:\\user.keytab" }, { "v1:345,v2:345,v3:345",
          null, "/hbase", "user1", "C:\\Documents and Settings\\user1\\user1.keytab" }, };
      assertEquals(urls.length, partsList.length);
      for (int i = 0; i < urls.length; i++) {
        int pos = 0;
        try {
          ZKConnectionInfo info = (ZKConnectionInfo) ConnectionInfo.create(urls[i], null, null);
  ...
  public void testGetMasterConnectionInfo() throws SQLException {
    ...
    String[] urls = new String[] { null, "", "jdbc:phoenix+master", "jdbc:phoenix+master;test=true",
      "jdbc:phoenix", "jdbc:phoenix+master:localhost", "localhost", "localhost;", "localhost:123",
      "localhost,localhost2:123;", "localhost\\:123", "localhost\\:123:", "localhost\\:123::",
      "localhost\\:123:::", "localhost\\:123::::", "localhost\\:123:::::",
      "localhost\\:123:345::::", "localhost,localhost2\\:123;", "localhost,localhost2\\:123:456",
      "localhost,localhost2\\:123:456;test=false", "localhost\\:123:::user/principal:/user.keytab",
      "localhost\\:123:::LongRunningQueries", "localhost\\:123:::LongRunningQueries:",
      "localhost\\:123:::LongRunningQueries::", "localhost\\:123:::user/principal:C:\\user.keytab",
      "localhost\\:123:::user/principal:C:\\Documents and Settings\\user1\\user1.keytab", };
    String[][] partsList = new String[][] { { defaultMasters }, { defaultMasters },
      { defaultMasters }, { defaultMasters }, { defaultMasters },
      { "localhost:" + HConstants.DEFAULT_MASTER_PORT },
      { "localhost:" + HConstants.DEFAULT_MASTER_PORT },
      { "localhost:" + HConstants.DEFAULT_MASTER_PORT }, { "localhost:123" },
      { "localhost2:123,localhost:123" }, { "localhost:123" }, { "localhost:123" },
      { "localhost:123" }, { "localhost:123" }, { "localhost:123" }, { "localhost:123" },
      { "localhost:123" }, { "localhost2:123,localhost:16000" }, { "localhost2:123,localhost:456" },
      { "localhost2:123,localhost:456" }, { "localhost:123", "user/principal", "/user.keytab" },
    ...
    for (int i = 0; i < urls.length; i++) {
      try {
        ...
        MasterConnectionInfo info =
          (MasterConnectionInfo) ConnectionInfo.create(urls[i], testConfig, null, null);
        String[] parts = partsList[i];
  ...
  public void testGetRPCConnectionInfo() throws SQLException {
    ...
    String[] urls = new String[] { null, "", "jdbc:phoenix+rpc", "jdbc:phoenix+rpc\";test=true",
      "jdbc:phoenix", "jdbc:phoenix+rpc\":localhost", "localhost", "localhost;", "localhost:123",
      "localhost,localhost2:123;", "localhost\\:123", "localhost\\:123:", "localhost\\:123::",
      "localhost\\:123:::", "localhost\\:123::::", "localhost\\:123:::::",
      "localhost\\:123:345::::", "localhost,localhost2\\:123;", "localhost,localhost2\\:123:456",
      "localhost,localhost2\\:123:456;test=false", "localhost\\:123:::user/principal:/user.keytab",
      ...
      "localhost\\:123:::LongRunningQueries::", "localhost\\:123:::user/principal:C:\\user.keytab",
      "localhost\\:123:::user/principal:C:\\Documents and Settings\\user1\\user1.keytab", };
    String[][] partsList = new String[][] { { defaultBoostraps }, { defaultBoostraps },
      { defaultBoostraps }, { defaultBoostraps }, { defaultBoostraps }, { "localhost" },
      { "localhost" }, { "localhost" }, { "localhost:123" }, { "localhost2:123,localhost:123" },
      { "localhost:123" }, { "localhost:123" }, { "localhost:123" }, { "localhost:123" },
      { "localhost:123" }, { "localhost:123" }, { "localhost:123" },
      // No default port
      { "localhost,localhost2:123" }, { "localhost2:123,localhost:456" },
      { "localhost2:123,localhost:456" }, { "localhost:123", "user/principal", "/user.keytab" },
      { "localhost:123", "LongRunningQueries", null },
      { "localhost:123", "LongRunningQueries", null },
      { "localhost:123", "LongRunningQueries", null },
    ...
    for (int i = 0; i < urls.length; i++) {
      try {
        ...
        RPCConnectionInfo info =
          (RPCConnectionInfo) ConnectionInfo.create(urls[i], testConfig, null, null);
        String[] parts = partsList[i];
        assertEquals(parts[0], info.getBoostrapServers());
        if (parts.length > 1) {
          assertEquals(parts[1], info.getPrincipal());
  ...
  public void testNegativeGetConnectionInfo() throws SQLException {
    String[] urls = new String[] {
      ...
      "jdbc:phoenix:v1:1,v2:2,v3:3", "jdbc:phoenix:v1:1,v2:2,v3:3;test=true",
      "jdbc:phoenix:v1,v2,v3:-1:/hbase;test=true", "jdbc:phoenix:v1,v2,v3:-1",
      "jdbc:phoenix+zk:v1:1,v2:2,v3:3", "jdbc:phoenix+zk:v1:1,v2:2,v3:3;test=true",
      "jdbc:phoenix+zk:v1,v2,v3:-1:/hbase;test=true", "jdbc:phoenix+zk:v1,v2,v3:-1" };
    for (String url : urls) {
      try {
  ...
  public void testRPCNegativeGetConnectionInfo() throws SQLException {
    ...
    String[] urls = new String[] {
      ...
      "jdbc:phoenix+rpc:v1:1,v2:2,v3:3", "jdbc:phoenix+rpc:v1:1,v2:2,v3:3;test=true",
      "jdbc:phoenix+rpc:v1,v2,v3:-1:/hbase;test=true", "jdbc:phoenix+rpc:v1,v2,v3:-1",
      "jdbc:phoenix+master:v1:1,v2:2,v3:3", "jdbc:phoenix+master:v1:1,v2:2,v3:3;test=true",
      "jdbc:phoenix+master:v1,v2,v3:-1:/hbase;test=true", "jdbc:phoenix+master:v1,v2,v3:-1",
  ...
  public void testMasterDefaults() throws SQLException {
    ...
    MasterConnectionInfo info =
      (MasterConnectionInfo) ConnectionInfo.create("jdbc:phoenix+master", config, null, null);
    ...
    config.set("hbase.client.registry.impl", "org.apache.hadoop.hbase.client.MasterRegistry");
    config.set("hbase.master.port", "17000");
    info = (MasterConnectionInfo) ConnectionInfo
      .create("jdbc:phoenix+master:master1.from.url,master2.from.url", config, null, null);
    ...
    config.set("hbase.master.port", "17000");
    info = (MasterConnectionInfo) ConnectionInfo
      .create("jdbc:phoenix+master:master1.from.url\\:123,master2.from.url", config, null, null);
    ...
    config.set("hbase.masters", "master1:123,master2:234,master3:345");
    info = (MasterConnectionInfo) ConnectionInfo
      .create("jdbc:phoenix:master1.from.url\\:123,master2.from.url:18000", config, null, null);
    ...
    config.set("hbase.master.port", "17000");
    config.set("hbase.masters", "master1:123,master2:234,master3:345");
    info = (MasterConnectionInfo) ConnectionInfo.create(
      "jdbc:phoenix:master1.from.url\\:123,master2.from.url\\:234:18000", config, null, null);
  ...
  public void testRPCDefaults() throws SQLException {
    ...
    config.set("hbase.client.registry.impl",
      "org.apache.hadoop.hbase.client.RpcConnectionRegistry");
    info = (RPCConnectionInfo) ConnectionInfo
      .create("jdbc:phoenix+rpc:bootstrap1.from.url,bootstrap2.from.url", config, null, null);
    ...
    config.set("hbase.client.registry.impl",
      "org.apache.hadoop.hbase.client.RpcConnectionRegistry");
    info = (RPCConnectionInfo) ConnectionInfo.create(
      "jdbc:phoenix+rpc:bootstrap1.from.url\\:123,bootstrap2.from.url\\::234", config, null, null);
    // TODO looks like HBase doesn't do port replacement/check for RPC servers either ?
  ...
  public void testPrincipalsMatching() throws Exception {
    ...
    assertTrue(
      ConnectionInfo.isSameName("user/localhost@EXAMPLE.COM", "user/localhost@EXAMPLE.COM"));
    // the user provided name might have a _HOST in it, which should be replaced by the hostname
    assertTrue(ConnectionInfo.isSameName("user/localhost@EXAMPLE.COM", "user/_HOST@EXAMPLE.COM",
      "localhost"));
    assertFalse(
      ConnectionInfo.isSameName("user/foobar@EXAMPLE.COM", "user/_HOST@EXAMPLE.COM", "localhost"));
    assertFalse(
      ConnectionInfo.isSameName("user@EXAMPLE.COM", "user/_HOST@EXAMPLE.COM", "localhost"));
    ...
    // seem to want to play nicely with the rest of the tests. Instead, we can just provide a
    // default realm
    // by hand.
    ...
    assertTrue(
      ConnectionInfo.isSameName("user/localhost@APACHE.ORG", "user/localhost", null, "APACHE.ORG"));
    assertFalse(ConnectionInfo.isSameName("user@APACHE.NET", "user", null, "APACHE.ORG"));
    assertFalse(
      ConnectionInfo.isSameName("user/localhost@APACHE.NET", "user/localhost", null, "APACHE.ORG"));
    assertTrue(ConnectionInfo.isSameName("user@APACHE.ORG", "user@APACHE.ORG", null, "APACHE.ORG"));
    assertTrue(ConnectionInfo.isSameName("user/localhost@APACHE.ORG", "user/localhost@APACHE.ORG",
      null, "APACHE.ORG"));

    assertTrue(ConnectionInfo.isSameName("user/localhost@APACHE.ORG", "user/_HOST", "localhost",
      "APACHE.ORG"));
    assertTrue(
      ConnectionInfo.isSameName("user/foobar@APACHE.ORG", "user/_HOST", "foobar", "APACHE.ORG"));
    assertFalse(ConnectionInfo.isSameName("user/localhost@APACHE.NET", "user/_HOST", "localhost",
      "APACHE.ORG"));
    assertFalse(
      ConnectionInfo.isSameName("user/foobar@APACHE.NET", "user/_HOST", "foobar", "APACHE.ORG"));
  }
  ...
  public void testMasterIPv6() throws SQLException {
    ...
    config.set("hbase.client.registry.impl", "org.apache.hadoop.hbase.client.MasterRegistry");
    config.set("hbase.master.port", "17000");
    MasterConnectionInfo info = (MasterConnectionInfo) ConnectionInfo
      .create("jdbc:phoenix+master:[::1],[\\:\\:2]", config, null, null);
    assertEquals(info.getBoostrapServers(), "[::1]:17000,[::2]:17000");

    config = HBaseFactoryProvider.getConfigurationFactory().getConfiguration();
    config.set("hbase.client.registry.impl", "org.apache.hadoop.hbase.client.MasterRegistry");
    info = (MasterConnectionInfo) ConnectionInfo
      .create("jdbc:phoenix+master:[::1]\\:123,[\\:\\:2]\\:234", config, null, null);
  ...
  public void testRPCIPv6() throws SQLException {
    ...
    config.set("hbase.client.registry.impl",
      "org.apache.hadoop.hbase.client.RpcConnectionRegistry");
    RPCConnectionInfo info = (RPCConnectionInfo) ConnectionInfo
      .create("jdbc:phoenix+rpc:[::1]\\:123,[\\:\\:2]\\::234", config, null, null);
  ...
  public void testZkIPv6() throws Exception {
    ConnectionInfo connectionInfo = ConnectionInfo.create("jdbc:phoenix+zk:"
      + "[::1],127.23.45.678\\:7634,v3\\:1,host123.48576\\:723:/hbase;" + "test=true", null, null);
    ...
    connectionInfo = ConnectionInfo.create("jdbc:phoenix+zk:"
      + "[::1]\\:2181,127.23.45.678\\:7634,v3\\:1,host123.48576\\:723:/hbase;" + "test=true", null,
      null);
    ...
    assertEquals("127.23.45.678:7634,[::1]:2181,host123.48576:723,v3:1",
      ...
      props.get(HConstants.ZOOKEEPER_QUORUM));
    connectionInfo = ConnectionInfo.create("jdbc:phoenix+zk:"
      + "[fe:80::],127.23.45.678\\:7634,v3\\:1,host123.48576\\:723:/hbase;" + "test=true", null,
      null);
    props = connectionInfo.asProps();
    ...
    connectionInfo = ConnectionInfo.create(
      "jdbc:phoenix+zk:"
        + "[fe:80::]\\:2181,127.23.45.678\\:7634,v3\\:1,host123.48576\\:723:/hbase;" + "test=true",
      null, null);
    props = connectionInfo.asProps();
    assertEquals("127.23.45.678:7634,[fe:80::]:2181,host123.48576:723,v3:1",
      props.get(HConstants.ZOOKEEPER_QUORUM));
    ...
    connectionInfo =
      ConnectionInfo.create(
        "jdbc:phoenix+zk:"
          + "[fe\\:80\\:\\:],127.23.45.678\\:7634,v3\\:1,host123.48576\\:723:/hbase;" + "test=true",
        null, null);
    props = connectionInfo.asProps();
    assertEquals("127.23.45.678:7634,[fe:80::]:2181,host123.48576:723,v3:1",
      props.get(HConstants.ZOOKEEPER_QUORUM));
