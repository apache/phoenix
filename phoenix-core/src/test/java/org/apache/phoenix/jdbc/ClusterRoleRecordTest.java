...
public class ClusterRoleRecordTest {
  ...
  public void testReadWriteJsonToFile() throws IOException {
    ClusterRoleRecord record = new ClusterRoleRecord(testName.getMethodName(),
  ...
  public void testGetActiveUrl() {
    String haGroupName = testName.getMethodName();
    {
      ClusterRoleRecord record = new ClusterRoleRecord(haGroupName, HighAvailabilityPolicy.FAILOVER,
        ZK1, ClusterRole.ACTIVE, ZK2, ClusterRole.STANDBY, 0);
      assertTrue(record.getActiveUrl().isPresent());
      assertEquals(ZK1, record.getActiveUrl().get());
    }
    {
      ClusterRoleRecord record = new ClusterRoleRecord(haGroupName, HighAvailabilityPolicy.FAILOVER,
        ZK1, ClusterRole.STANDBY, ZK2, ClusterRole.STANDBY, 0);
  ...
  public void testIsNewerThan() {
    ...
    ClusterRoleRecord recordV0 = new ClusterRoleRecord(haGroupName, HighAvailabilityPolicy.FAILOVER,
      ZK1, ClusterRole.STANDBY, ZK2, ClusterRole.STANDBY, 0);
    ClusterRoleRecord recordV1 = new ClusterRoleRecord(haGroupName, HighAvailabilityPolicy.FAILOVER,
      ZK1, ClusterRole.STANDBY, ZK2, ClusterRole.STANDBY, 2);
    ...
    ClusterRoleRecord record2 = new ClusterRoleRecord(haGroupName2, HighAvailabilityPolicy.FAILOVER,
      ZK1, ClusterRole.STANDBY, ZK2, ClusterRole.STANDBY, 1);
  ...
  public void testHasSameInfo() {
    ...
    ClusterRoleRecord recordV0 = new ClusterRoleRecord(haGroupName, HighAvailabilityPolicy.FAILOVER,
      ZK1, ClusterRole.ACTIVE, ZK2, ClusterRole.STANDBY, 0);
    ClusterRoleRecord recordV1 = new ClusterRoleRecord(haGroupName, HighAvailabilityPolicy.FAILOVER,
      ZK1, ClusterRole.ACTIVE, ZK2, ClusterRole.STANDBY, 1);
  ...
  public void testHasSameInfoDifferentZKOrder() {
    String haGroupName = testName.getMethodName();
    ClusterRoleRecord recordV0 = new ClusterRoleRecord(haGroupName, HighAvailabilityPolicy.FAILOVER,
      ZK2, ClusterRole.ACTIVE, ZK1, ClusterRole.STANDBY, 0);
    ClusterRoleRecord recordV1 = new ClusterRoleRecord(haGroupName, HighAvailabilityPolicy.FAILOVER,
      ZK1, ClusterRole.ACTIVE, ZK2, ClusterRole.STANDBY, 1);
    assertTrue(recordV1.hasSameInfo(recordV0));
    assertTrue(recordV1.hasSameInfo(recordV1));
  ...
  public void testHasSameInfoDifferentHostOrder() {
    ...
    String haGroupName = testName.getMethodName();
    ClusterRoleRecord recordV0 = new ClusterRoleRecord(haGroupName, HighAvailabilityPolicy.FAILOVER,
      ZK2, ClusterRole.ACTIVE, hostzk1ordered, ClusterRole.STANDBY, 0);
    ClusterRoleRecord recordV1 = new ClusterRoleRecord(haGroupName, HighAvailabilityPolicy.FAILOVER,
      hostzk1unordered, ClusterRole.ACTIVE, ZK2, ClusterRole.STANDBY, 1);
    assertTrue(recordV1.hasSameInfo(recordV0));
    assertTrue(recordV1.hasSameInfo(recordV1));
    assertTrue(recordV0.hasSameInfo(recordV1));
  }
  ...
  public void testHasSameInfoNegative() {
    String haGroupName = testName.getMethodName();
    ClusterRoleRecord record = new ClusterRoleRecord(haGroupName, HighAvailabilityPolicy.PARALLEL,
      ZK1, ClusterRole.ACTIVE, ZK2, ClusterRole.STANDBY, 0);

    ClusterRoleRecord recordFailover = new ClusterRoleRecord(haGroupName,
      HighAvailabilityPolicy.FAILOVER, ZK1, ClusterRole.ACTIVE, ZK2, ClusterRole.STANDBY, 1);
    assertFalse(record.hasSameInfo(recordFailover));
    assertFalse(recordFailover.hasSameInfo(record));

    String haGroupName2 = haGroupName + RandomStringUtils.randomAlphabetic(2);
    ClusterRoleRecord record2 = new ClusterRoleRecord(haGroupName2, HighAvailabilityPolicy.PARALLEL,
      ZK1, ClusterRole.ACTIVE, ZK2, ClusterRole.STANDBY, 1);
  ...
  public void testGetRole() {
    ClusterRoleRecord record = new ClusterRoleRecord(testName.getMethodName(),
      HighAvailabilityPolicy.FAILOVER, ZK1, ClusterRole.ACTIVE, ZK2, ClusterRole.STANDBY, 0);
  ...
  public void testToPrettyString() {
    ClusterRoleRecord record = new ClusterRoleRecord(testName.getMethodName(),
      HighAvailabilityPolicy.PARALLEL, ZK1, ClusterRole.ACTIVE, ZK2, ClusterRole.STANDBY, 1);
