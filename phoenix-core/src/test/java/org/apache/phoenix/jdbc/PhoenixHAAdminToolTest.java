...
public class PhoenixHAAdminToolTest {
  ...
  private final PhoenixHAAdminTool.HighAvailibilityCuratorProvider mockHighAvailibilityCuratorProvider =
  ...
  private final PhoenixHAAdminHelper admin =
    new PhoenixHAAdminHelper(ZK1, new Configuration(), mockHighAvailibilityCuratorProvider);
  ...
  public void testGetZookeeperQuorum() {
    ...
    final String localZk = String.format("127.0.0.1:%d:%s", HConstants.DEFAULT_ZOOKEPER_CLIENT_PORT,
