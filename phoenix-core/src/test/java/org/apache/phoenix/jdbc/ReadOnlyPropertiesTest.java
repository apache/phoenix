...
public class ReadOnlyPropertiesTest {
  ...
  private static final Map<String, String> DEFAULT_PROPS_MAP =
    ImmutableMap.of(PROPERTY_NAME_1, DEFAULT_VALUE_1, PROPERTY_NAME_2, DEFAULT_VALUE_2);
  ...
  public void testDefaultProperties() {
    ...
    ReadOnlyProps readOnlyProps =
      new ReadOnlyProps(defaultProps, EMPTY_OVERRIDE_MAP.entrySet().iterator());
  ...
  public void testOverrideProperties() {
    ReadOnlyProps defaultProps = new ReadOnlyProps(DEFAULT_PROPS_MAP);
    ReadOnlyProps readOnlyProps =
      new ReadOnlyProps(defaultProps, OVERRIDE_MAP.entrySet().iterator());
