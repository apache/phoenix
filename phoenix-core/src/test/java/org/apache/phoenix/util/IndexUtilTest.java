...
public class IndexUtilTest {
    ...
    private void verifyIndexColumnDataTypes(boolean isNullable, String expected) {
        ...
        for (PDataType dataType : PDataType.values()) {
            ...
            try {
                indexColumnDataType = IndexUtil.getIndexColumnDataType(isNullable, dataType).getSqlTypeName();
            } catch (IllegalArgumentException e) {
            }
            indexColumnDataTypes.put(dataType.getSqlTypeName(), indexColumnDataType);
        }
