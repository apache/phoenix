...
public class EquiDepthStreamHistogramTest {
  ...
  public void testComparator() {
    ...
    assertEquals(-4,
      Collections.binarySearch(barList, new Bar(Bytes.toBytes("e"), Bytes.toBytes("e"))));
  ...
  private int getLength(Bucket last) {
    return Math
      .abs(Bytes.toInt(last.getLeftBoundInclusive()) - Bytes.toInt(last.getRightBoundExclusive()));
  }
}
