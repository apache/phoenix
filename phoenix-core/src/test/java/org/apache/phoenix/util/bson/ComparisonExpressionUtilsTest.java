...
public class ComparisonExpressionUtilsTest {
  ...
  public void testSQLComparisonExpression1() {
    ...
    assertTrue(SQLComparisonExpressionUtils
      .evaluateConditionExpression("(field_exists(Id) OR field_not_exists(Title))"));
  ...
  public void testSQLComparisonExpression2() {
    ...
    assertTrue(SQLComparisonExpressionUtils
      .evaluateConditionExpression("(exists('Id') || !exists('Title'))"));

    assertTrue(SQLComparisonExpressionUtils
      .evaluateConditionExpression("((!exists('Id') && !exists('Title1')) || exists('ISBN2')) || "
        + "((!isEquals('Id', '#Title'))" + " && ((isEquals('InPublication', 'InPublication'))"
    ...
    assertTrue(
      SQLComparisonExpressionUtils.evaluateConditionExpression("isEquals('NestedMap1.Id', '$Id')"
    ...
    assertTrue(SQLComparisonExpressionUtils
      .evaluateConditionExpression("lessThanOrEquals('NestedList1[0]', '$NestedList1_485')"
    ...
    assertTrue(SQLComparisonExpressionUtils
      .evaluateConditionExpression("lessThanOrEquals('NestedList1[0]', '$NestedList1_485')"
        ...
        + " && lessThanOrEquals('IdS', '$Ids1')" + " && greaterThanOrEquals('Id2', '$Id2')"
        + " && greaterThanOrEquals('NestedMap1.NList1[2]', '#NestedMap1_NList1_3')"));

    assertTrue(SQLComparisonExpressionUtils
      .evaluateConditionExpression("greaterThanOrEquals('NestedList1[0]', '$NestedList1_4850')"
