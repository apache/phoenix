...
public class ScanUtilTest {
  ...
  public static class ParameterizedScanUtilTest {
    ...
    public ParameterizedScanUtilTest(List<List<KeyRange>> slots, int[] widths, byte[] expectedKey,
      Bound bound) throws Exception {
    ...
    public void test() {
      ...
      int offset = ScanUtil.setKey(schema, slots, ScanUtil.getDefaultSlotSpans(slots.size()),
        position, bound, key, 0, 0, slots.size());
    ...
    public static synchronized Collection<Object> data() {
      ...
      testCases
        .addAll(foreach(
          new KeyRange[][] {
            ...
            { PChar.INSTANCE.getKeyRange(Bytes.toBytes("A"), true, Bytes.toBytes("A"), true,
              SortOrder.ASC), } },
          new int[] { 1, 1, 1 }, PChar.INSTANCE.toBytes("a1A"), Bound.LOWER));
      ...
      testCases
        .addAll(foreach(
          new KeyRange[][] {
            ...
            { PChar.INSTANCE.getKeyRange(Bytes.toBytes("A"), false, Bytes.toBytes("B"), true,
              SortOrder.ASC), } },
          new int[] { 1, 1, 1 }, PChar.INSTANCE.toBytes("b2B"), Bound.LOWER));
      ...
      testCases
        .addAll(foreach(
          new KeyRange[][] {
            ...
            { PChar.INSTANCE.getKeyRange(Bytes.toBytes("A"), false, Bytes.toBytes("B"), true,
              SortOrder.ASC), } },
          new int[] { 1, 1, 1 }, PChar.INSTANCE.toBytes("b1B"), Bound.LOWER));
      ...
      testCases
        .addAll(foreach(
          new KeyRange[][] {
            ...
            { PChar.INSTANCE.getKeyRange(Bytes.toBytes("A"), false, Bytes.toBytes("B"), true,
              SortOrder.ASC), } },
          new int[] { 1, 1, 1 }, PChar.INSTANCE.toBytes("a1B"), Bound.LOWER));
      // 7, Lower bound, unbound key in the middle, fixed length.
      testCases
        .addAll(foreach(
          new KeyRange[][] {
            { PChar.INSTANCE
              .getKeyRange(Bytes.toBytes("a"), true, Bytes.toBytes("a"), true, SortOrder.ASC), },
            { KeyRange.EVERYTHING_RANGE, },
            { PChar.INSTANCE.getKeyRange(Bytes.toBytes("A"), false, Bytes.toBytes("B"), true,
              SortOrder.ASC), } },
          new int[] { 1, 1, 1 }, PChar.INSTANCE.toBytes("a"), Bound.LOWER));
      // 8, Lower bound, unbound key in the middle, variable length.
      testCases.addAll(foreach(
        new KeyRange[][] { { PChar.INSTANCE.getKeyRange(Bytes.toBytes("a"), true,
          Bytes.toBytes("a"), true, SortOrder.ASC), }, { KeyRange.EVERYTHING_RANGE, } },
        new int[] { 1, 1 }, PChar.INSTANCE.toBytes("a"), Bound.LOWER));
      ...
      testCases
        .addAll(foreach(
          new KeyRange[][] {
            ...
            { PChar.INSTANCE.getKeyRange(Bytes.toBytes("A"), true, Bytes.toBytes("A"), true,
              SortOrder.ASC), } },
          new int[] { 1, 1, 1 }, PChar.INSTANCE.toBytes("a1B"), Bound.UPPER));
      ...
      testCases
        .addAll(foreach(
          new KeyRange[][] {
            ...
            { PChar.INSTANCE.getKeyRange(Bytes.toBytes("A"), true, Bytes.toBytes("B"), true,
              SortOrder.ASC), } },
          new int[] { 1, 1, 1 }, PChar.INSTANCE.toBytes("b2C"), Bound.UPPER));
      ...
      testCases
        .addAll(foreach(
          new KeyRange[][] {
            ...
            { PChar.INSTANCE.getKeyRange(Bytes.toBytes("A"), true, Bytes.toBytes("B"), false,
              SortOrder.ASC), } },
          new int[] { 1, 1, 1 }, PChar.INSTANCE.toBytes("b"), Bound.UPPER));
        ...
        .addAll(
          foreach(
            new KeyRange[][] {
              ...
              { PChar.INSTANCE.getKeyRange(Bytes.toBytes("1"), true, Bytes.toBytes("2"), true,
                SortOrder.ASC), } },
            new int[] { 1, 1 }, PChar.INSTANCE.toBytes("a3"), Bound.UPPER));
      ...
      testCases.addAll(foreach(new KeyRange[][] {
        ...
        { PChar.INSTANCE.getKeyRange(Bytes.toBytes("1"), true, Bytes.toBytes("1"), true,
          SortOrder.ASC), } },
        new int[] { 1, 1 }, PChar.INSTANCE.toBytes("b"), Bound.UPPER));
        ...
        .addAll(
          foreach(
            new KeyRange[][] {
              ...
              { PChar.INSTANCE.getKeyRange(Bytes.toBytes("1"), true, Bytes.toBytes("1"), true,
                SortOrder.ASC), } },
            new int[] { 1, 1 }, PChar.INSTANCE.toBytes("b2"), Bound.UPPER));
        ...
        .addAll(
          foreach(
            new KeyRange[][] {
              ...
              { PChar.INSTANCE.getKeyRange(Bytes.toBytes("1"), true, Bytes.toBytes("2"), false,
                SortOrder.ASC), } },
            new int[] { 1, 1 }, PChar.INSTANCE.toBytes("a2"), Bound.UPPER));
      ...
      testCases.addAll(foreach(
        new KeyRange[][] {
          { PChar.INSTANCE.getKeyRange(Bytes.toBytes("a"), true, Bytes.toBytes("a"), true,
            SortOrder.ASC), },
          { PVarchar.INSTANCE
            .getKeyRange(Bytes.toBytes("A"), true, Bytes.toBytes("B"), true, SortOrder.ASC), } },
        new int[] { 1, 0 },
        ByteUtil.nextKey(
          ByteUtil.concat(PVarchar.INSTANCE.toBytes("aB"), QueryConstants.SEPARATOR_BYTE_ARRAY)),
        Bound.UPPER));
      return testCases;
    }
  ...
  public static class NonParameterizedScanUtilTest {
    ...
    public void testSlotsSaltedVarbinaryPk() {
      ...
      int offset = ScanUtil.setKey(builder.build(), pkKeyRanges, slotSpans, new int[] { 0 },
        Bound.UPPER, key, 0, 0, slotSpans.length);
      byte[] actualKey = new byte[offset];
      System.arraycopy(key, 0, actualKey, 0, offset);
    ...
    public void testLastPkColumnIsVariableLengthAndDescBug5307() throws Exception {
      ...
      List<List<KeyRange>> rowKeySlotRangesList = Arrays.asList(
        Arrays.asList(KeyRange.getKeyRange(PVarchar.INSTANCE.toBytes("obj1", SortOrder.ASC)),
        ...
        Arrays.asList(KeyRange.getKeyRange(PVarchar.INSTANCE.toBytes("2222", SortOrder.DESC)),
      ...
      int rowKeyLength = ScanUtil.setKey(rowKeySchema, rowKeySlotRangesList, rowKeySlotSpans,
        rowKeySlotRangesIndexes, Bound.LOWER, rowKey, 0, 0, 2);
      byte[] startKey = Arrays.copyOf(rowKey, rowKeyLength);

      rowKeySlotRangesIndexes = new int[] { 2, 2 };
      rowKey = new byte[1024];
      rowKeyLength = ScanUtil.setKey(rowKeySchema, rowKeySlotRangesList, rowKeySlotSpans,
        rowKeySlotRangesIndexes, Bound.UPPER, rowKey, 0, 0, 2);
      byte[] endKey = Arrays.copyOf(rowKey, rowKeyLength);

      byte[] expectedStartKey = ByteUtil.concat(PVarchar.INSTANCE.toBytes("obj1", SortOrder.ASC),
      ...
      byte[] expectedEndKey = ByteUtil.concat(PVarchar.INSTANCE.toBytes("obj3", SortOrder.ASC),
    ...
    public void testPhoenixTTLUtilMethods() throws SQLException {
      ...
      try (Connection conn = driver.connect(getUrl(), props)) {
        ...
        Cell cell42 = ExtendedCellBuilderFactory.create(CellBuilderType.DEEP_COPY)
          .setRow(Bytes.toBytes(row)).setFamily(emptyColumnFamilyName).setQualifier(emptyColumnName)
          .setTimestamp(timestamp42).setType(type42.getCode()).setValue(Bytes.toBytes(value42))
          .setSequenceId(seqId42).build();
        ...
        long seqId43 = 1043L;
        Cell cell43 =
          ExtendedCellBuilderFactory.create(CellBuilderType.DEEP_COPY).setRow(Bytes.toBytes(row))
            .setFamily(emptyColumnFamilyName).setQualifier(Bytes.toBytes(columnName))
            .setTimestamp(timestamp43).setType(type43.getCode()).setValue(Bytes.toBytes(value43))
            .setSequenceId(seqId43).build();
        // Add cell to the cell list
        cellList.add(cell43);
