  ...
  public static class PhoenixTTLScanUtilTest extends BaseConnectionlessQueryTest {
    ...
    public void testPhoenixTTLUtilMethods() throws SQLException {
      ...
      try (Connection conn = driver.connect(getUrl(), props)) {
        ...
        Cell cell42 = CellUtil.createCell(Bytes.toBytes(row), emptyColumnFamilyName,
          emptyColumnName, timestamp42, type42.getCode(), Bytes.toBytes(value42), seqId42);
        ...
        long seqId43 = 1043L;
        Cell cell43 =
          CellUtil.createCell(Bytes.toBytes(row), emptyColumnFamilyName, Bytes.toBytes(columnName),
