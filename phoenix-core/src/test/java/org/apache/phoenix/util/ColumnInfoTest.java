...
public class ColumnInfoTest {
  ...
  public void testOptionalDescriptionType() {
    ...
    // Array types
    testType(new ColumnInfo("a.myColumn", PCharArray.INSTANCE.getSqlType(), 3),
      "CHAR(3) ARRAY:\"a\".\"myColumn\"");
    testType(new ColumnInfo("a.myColumn", PDecimalArray.INSTANCE.getSqlType(), 10, 2),
      "DECIMAL(10,2) ARRAY:\"a\".\"myColumn\"");
    testType(new ColumnInfo("a.myColumn", PVarcharArray.INSTANCE.getSqlType(), 4),
      "VARCHAR(4) ARRAY:\"a\".\"myColumn\"");
  }
