...
public class QueryUtilTest {
  ...
  // Copied from HBase HConstants, so that the test compiles with HBase 2.1 and 2.2
  ...
  public void testCreateConnectionFromConfiguration() throws Exception {
    ...
    conf.set(CLIENT_CONNECTION_REGISTRY_IMPL_CONF_KEY, ZKConnectionInfo.ZK_REGISTRY_NAME);
