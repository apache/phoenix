...
public class EncodedQualifiersColumnProjectionFilterTest extends TestCase {
  ...
  private final QualifierEncodingScheme someQualifiedEncodingScheme =
    QualifierEncodingScheme.ONE_BYTE_QUALIFIERS;
  ...
  public EncodedQualifiersColumnProjectionFilterTest() {
    ...
    this.filter = new EncodedQualifiersColumnProjectionFilter(this.someEmptyCFName.getBytes(),
      someBitSet, conditionalCFNames, this.someQualifiedEncodingScheme);
  }
