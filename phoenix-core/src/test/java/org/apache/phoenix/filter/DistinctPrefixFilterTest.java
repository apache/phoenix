...
public class DistinctPrefixFilterTest extends TestCase {
  ...
  private void assertInclude(byte[] next, Filter f) throws IOException {
    Cell c = new KeyValue(next, ByteUtil.EMPTY_BYTE_ARRAY, ByteUtil.EMPTY_BYTE_ARRAY, 0,
  ...
  private void assertSeekAndHint(String next, Filter f, String rowHint, boolean filterAll)
    throws IOException {
    assertSeekAndHint(Bytes.toBytes(next), f, Bytes.toBytes(rowHint), filterAll);
  }

  private void assertSeekAndHint(byte[] next, Filter f, byte[] rowHint, boolean filterAll)
    throws IOException {
    Cell c = new KeyValue(next, ByteUtil.EMPTY_BYTE_ARRAY, ByteUtil.EMPTY_BYTE_ARRAY, 0,
      ByteUtil.EMPTY_BYTE_ARRAY);
    ...
    assertTrue(Bytes.equals(hintBytes, 0, hintBytes.length, h.getRowArray(), h.getRowOffset(),
      h.getRowLength()));
  ...
  public void testMultiFixedWidth() throws Exception {
    ...
    assertSeekAndHint(new byte[] { '0', '0', '4', 'a', 'a' }, f, new byte[] { '0', '0', '4' },
      false);
    assertInclude("003aa", f);
    assertInclude("002aa", f);
    assertInclude("001aa", f);
    assertSeekAndHint(new byte[] { '0', '0', '1', 'a', 'a' }, f, new byte[] { '0', '0', '1' },
      false);
    ...
    assertSeekAndHint(new byte[] { '0', '0', '3', 'b', 'b' }, f,
      new byte[] { '0', '0', '3', 'b', 'b' }, false);
    assertInclude("003ba", f);
    assertInclude("002bb", f);
    assertInclude("001bb", f);
    assertSeekAndHint(new byte[] { '0', '0', '1', 'b', 'b' }, f,
      new byte[] { '0', '0', '1', 'b', 'b' }, false);
  }
  ...
  public void testMultiVariableWidth() throws Exception {
    ...
    assertSeekAndHint(new byte[] { '0', '0', '4', 0, 'a', 'a' }, f, new byte[] { '0', '0', '4' },
      false);
