    ...
    public static Collection<Object> data() {
        ...
        testCases.addAll(foreach(
                new KeyRange[][] {{
                    ...
                    PDataType.CHAR.getKeyRange(Bytes.toBytes("m"), true, Bytes.toBytes("u"), false),
                    PDataType.CHAR.getKeyRange(Bytes.toBytes("z"), true, Bytes.toBytes("z"), true),
                    }, {
                    PDataType.CHAR.getKeyRange(Bytes.toBytes("A"), true, Bytes.toBytes("A"), true),                        
                    PDataType.CHAR.getKeyRange(Bytes.toBytes("D"), true, Bytes.toBytes("D"), true),
                    PDataType.CHAR.getKeyRange(Bytes.toBytes("M"), true, Bytes.toBytes("M"), true),                        
                    }
                },
                new int[] {1,1,1,1,1},
                Bytes.toBytes("bkCpM"),
