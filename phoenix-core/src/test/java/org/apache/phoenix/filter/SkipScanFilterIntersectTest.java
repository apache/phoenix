...
public class SkipScanFilterIntersectTest {
  ...
  public SkipScanFilterIntersectTest(List<List<KeyRange>> slots, RowKeySchema schema,
    byte[] lowerInclusiveKey, byte[] upperExclusiveKey, List<List<KeyRange>> expectedNewSlots) {
    ...
    testCases.addAll(foreach(
      new KeyRange[][] {
        ...
        { PChar.INSTANCE.getKeyRange(Bytes.toBytes("B"), true, Bytes.toBytes("B"), true,
          SortOrder.ASC),
          PChar.INSTANCE
            .getKeyRange(Bytes.toBytes("C"), true, Bytes.toBytes("D"), true, SortOrder.ASC), } },
    ...
    testCases.addAll(foreach(
      new KeyRange[][] {
        ...
        { PChar.INSTANCE.getKeyRange(Bytes.toBytes("B"), true, Bytes.toBytes("B"), true,
          SortOrder.ASC),
          PChar.INSTANCE
            .getKeyRange(Bytes.toBytes("C"), true, Bytes.toBytes("E"), true, SortOrder.ASC), } },
  ...
  private static Collection<?> foreach(KeyRange[][] ranges, int[] widths, byte[] lowerInclusive,
    ...
    List<List<KeyRange>> expectedSlots = expectedRanges == null
      ? null
      : Lists.transform(Lists.newArrayList(expectedRanges), ARRAY_TO_LIST);
