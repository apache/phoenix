...
public class ArrayToStringFunctionTest {
  ...
  private static void testExpression(LiteralExpression array, LiteralExpression delimiter,
    LiteralExpression nullString, String expected) throws SQLException {
    ...
    String result = (String) arrayToStringFunction.getDataType().toObject(ptr,
      arrayToStringFunction.getSortOrder(), arrayToStringFunction.getMaxLength(),
      arrayToStringFunction.getScale());
    assertEquals(expected, result);
  }

  private static void test(PhoenixArray array, PDataType arrayDataType, Integer arrMaxLen,
    Integer arrScale, String delimiter, String nullString, String expected,
    SortOrder arraySortOrder, SortOrder delimiterSortOrder, SortOrder nullStringSortOrder)
    throws SQLException {
    ...
    delimiterLiteral = LiteralExpression.newConstant(delimiter, PVarchar.INSTANCE, null, null,
      delimiterSortOrder, Determinism.ALWAYS);
    nullStringLiteral = LiteralExpression.newConstant(nullString, PVarchar.INSTANCE, null, null,
  ...
  public void testInt1() throws SQLException {
    ...
    test(arr, type, null, null, delimiter, nullString, expected, SortOrder.ASC, SortOrder.ASC,
      SortOrder.ASC);
    test(arr, type, null, null, delimiter, nullString, expected, SortOrder.DESC, SortOrder.ASC,
      SortOrder.ASC);
  }
  ...
  public void testDecimal1() throws SQLException {
    ...
    Object[] o1 = new Object[] { BigDecimal.valueOf(23.45), BigDecimal.valueOf(2.345),
  ...
  public void testDecimal3() throws SQLException {
    PDataType type = PDecimalArray.INSTANCE;
    PDataType base = PDecimal.INSTANCE;
    Object[] o1 = new Object[] { BigDecimal.valueOf(23.45), BigDecimal.valueOf(2.345), null,
      BigDecimal.valueOf(234.5) };
    PhoenixArray arr = new PhoenixArray(base, o1);
    String delimiter = ",";
    String nullString = "*";
