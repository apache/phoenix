...
public class StringToArrayFunctionTest {
  ...
  private static void testExpression(LiteralExpression array, LiteralExpression delimiter,
    LiteralExpression nullString, PhoenixArray expected) throws SQLException {
    ...
    PhoenixArray result = (PhoenixArray) stringToArrayFunction.getDataType().toObject(ptr,
      stringToArrayFunction.getSortOrder(), stringToArrayFunction.getMaxLength(),
      stringToArrayFunction.getScale());
    assertEquals(expected, result);
  }

  private static void test(String string, String delimiter, String nullString,
    PhoenixArray expected, SortOrder stringSortOrder, SortOrder delimiterSortOrder,
    SortOrder nullStringSortOrder, PDataType stringType, PDataType delimiterType,
    PDataType nullStringType) throws SQLException {
    LiteralExpression arrayLiteral, delimiterLiteral, nullStringLiteral;
    arrayLiteral = LiteralExpression.newConstant(string, stringType, null, null, stringSortOrder,
      Determinism.ALWAYS);
    delimiterLiteral = LiteralExpression.newConstant(delimiter, delimiterType, null, null,
      delimiterSortOrder, Determinism.ALWAYS);
    nullStringLiteral = LiteralExpression.newConstant(nullString, nullStringType, null, null,
      nullStringSortOrder, Determinism.ALWAYS);
  ...
  public void testStringToArrayFunction1() throws SQLException {
    ...
    String delimiter = ",";
    String nullString = "*";
    test(string, delimiter, nullString, expected, SortOrder.ASC, SortOrder.ASC, SortOrder.ASC,
      PVarchar.INSTANCE, PVarchar.INSTANCE, PVarchar.INSTANCE);
    test(string, delimiter, nullString, expected, SortOrder.DESC, SortOrder.ASC, SortOrder.ASC,
      PVarchar.INSTANCE, PVarchar.INSTANCE, PVarchar.INSTANCE);
  }
  ...
  public void testStringToArrayFunction17() throws SQLException {
    ...
    String nullString = "null";
    test(string, delimiter, nullString, expected, SortOrder.ASC, SortOrder.ASC, SortOrder.ASC,
      PChar.INSTANCE, PVarchar.INSTANCE, PVarchar.INSTANCE);
    test(string, delimiter, nullString, expected, SortOrder.DESC, SortOrder.ASC, SortOrder.ASC,
      PChar.INSTANCE, PVarchar.INSTANCE, PVarchar.INSTANCE);
  }
  ...
  public void testStringToArrayFunction18() throws SQLException {
    ...
    String nullString = "null";
    test(string, delimiter, nullString, expected, SortOrder.ASC, SortOrder.ASC, SortOrder.ASC,
      PChar.INSTANCE, PChar.INSTANCE, PVarchar.INSTANCE);
    test(string, delimiter, nullString, expected, SortOrder.DESC, SortOrder.ASC, SortOrder.ASC,
      PChar.INSTANCE, PChar.INSTANCE, PVarchar.INSTANCE);
  }
  ...
  public void testStringToArrayFunction19() throws SQLException {
    ...
    String nullString = "null";
    test(string, delimiter, nullString, expected, SortOrder.ASC, SortOrder.ASC, SortOrder.ASC,
      PChar.INSTANCE, PChar.INSTANCE, PChar.INSTANCE);
    test(string, delimiter, nullString, expected, SortOrder.DESC, SortOrder.ASC, SortOrder.ASC,
      PChar.INSTANCE, PChar.INSTANCE, PChar.INSTANCE);
  }
