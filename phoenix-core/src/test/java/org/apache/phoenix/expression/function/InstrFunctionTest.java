...
public class InstrFunctionTest {
    ...
    public void testInstrFunction() throws SQLException {
        ...
        inputExpression("A??FGH",PVarchar.INSTANCE, "??", 1, SortOrder.ASC);
        
        inputExpression("A??FGH",PVarchar.INSTANCE, "??", 1, SortOrder.DESC);
        
        inputExpression("A??FGH",PVarchar.INSTANCE, "?FGH", 2, SortOrder.ASC);
        
        inputExpression("A??FGH",PVarchar.INSTANCE, "?FGH", 2, SortOrder.DESC);
        
        inputExpression("A??F/GH",PVarchar.INSTANCE, "?F/GH", 2, SortOrder.ASC);
        
        inputExpression("A??F/GH",PVarchar.INSTANCE, "?F/GH", 2, SortOrder.DESC);
    }
