...
public class ArrayAppendFunctionTest {
  ...
  private static void testExpression(LiteralExpression array, LiteralExpression element,
    ...
    PhoenixArray result = (PhoenixArray) arrayAppendFunction.getDataType().toObject(ptr,
  ...
  public void testArrayAppendFunction6() throws Exception {
    ...
    Object[] o2 = new Object[] { new Float(2.3), new Float(7.9), new Float(-9.6), new Float(2.3),
      new Float(8.9) };
    Object element = 8.9;
  ...
  public void testArrayAppendFunction9() throws Exception {
    ...
    Object[] o2 =
      new Object[] { (short) 34, (short) -23, (short) -89, (short) 999, (short) 34, (short) 7 };
  ...
  public void testArrayAppendFunction11() throws Exception {
    ...
    Object[] o2 = new Object[] { BigDecimal.valueOf(2345), BigDecimal.valueOf(-23.45),
      BigDecimal.valueOf(785), BigDecimal.valueOf(-19) };
  ...
  public void testForCorrectSeparatorBytes1() throws Exception {
    ...
    ImmutableBytesWritable ptr = new ImmutableBytesWritable();
    arrayAppendFunction.evaluate(null, ptr);
    byte[] expected = new byte[] { 97, 0, 98, 0, 99, 0, 100, 0, 0, 0, -128, 1, -128, 3, -128, 5,
  ...
  public void testForCorrectSeparatorBytes2() throws Exception {
    ...
    ImmutableBytesWritable ptr = new ImmutableBytesWritable();
    arrayAppendFunction.evaluate(null, ptr);
    byte[] expected = new byte[] { -98, -1, -99, -1, -100, -1, -101, -1, -1, -1, -128, 1, -128, 3,
  ...
  public void testForCorrectSeparatorBytes3() throws Exception {
    ...
    ImmutableBytesWritable ptr = new ImmutableBytesWritable();
    arrayAppendFunction.evaluate(null, ptr);
    byte[] expected = new byte[] { -98, -1, 0, -2, -100, -1, -101, -1, -1, -1, -128, 1, -128, 3,
      -128, 3, -128, 5, -128, 7, 0, 0, 0, 10, 0, 0, 0, 5, 1 };
    assertArrayEquals(expected, ptr.get());
  }
}
