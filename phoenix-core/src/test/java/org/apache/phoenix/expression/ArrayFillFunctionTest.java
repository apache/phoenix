...
public class ArrayFillFunctionTest {
  ...
  private static void testExpression(LiteralExpression element, LiteralExpression length,
    ...
    PhoenixArray result =
      (PhoenixArray) arrayFillFunction.getDataType().toObject(ptr, arrayFillFunction.getSortOrder(),
        arrayFillFunction.getMaxLength(), arrayFillFunction.getScale());
    assertEquals(expected, result);
  }

  private static void test(Object element, Object length, PDataType elementDataType,
    Integer elementMaxLen, Integer elementScale, PDataType lengthDataType, Integer lengthMaxlen,
    Integer lengthScale, PhoenixArray expected, SortOrder elementSortOrder,
    SortOrder lengthSortOrder) throws SQLException {
    LiteralExpression elementLiteral, lengthLiteral;
    elementLiteral = LiteralExpression.newConstant(element, elementDataType, elementMaxLen,
      elementScale, elementSortOrder, Determinism.ALWAYS);
    lengthLiteral = LiteralExpression.newConstant(length, lengthDataType, lengthMaxlen, lengthScale,
      lengthSortOrder, Determinism.ALWAYS);
  ...
  public void testForInt() throws SQLException {
    ...
    test(element, length, baseType, null, null, PInteger.INSTANCE, null, null, e, SortOrder.ASC,
      SortOrder.ASC);
    test(element, length, baseType, null, null, PInteger.INSTANCE, null, null, e, SortOrder.ASC,
      SortOrder.DESC);
    test(element, length, baseType, null, null, PInteger.INSTANCE, null, null, e, SortOrder.DESC,
      SortOrder.DESC);
    test(element, length, baseType, null, null, PInteger.INSTANCE, null, null, e, SortOrder.DESC,
      SortOrder.ASC);
  }
  ...
  public void testForBoolean() throws SQLException {
    ...
    PhoenixArray e =
      new PhoenixArray.PrimitiveBooleanPhoenixArray(baseType, new Object[] { false, false, false });
    test(element, length, baseType, null, null, PInteger.INSTANCE, null, null, e, SortOrder.ASC,
      SortOrder.ASC);
    test(element, length, baseType, null, null, PInteger.INSTANCE, null, null, e, SortOrder.ASC,
      SortOrder.DESC);
  ...
  public void testForDouble() throws SQLException {
    ...
    PhoenixArray e =
      new PhoenixArray.PrimitiveDoublePhoenixArray(baseType, new Object[] { 34.67, 34.67, 34.67 });
    test(element, length, baseType, null, null, PInteger.INSTANCE, null, null, e, SortOrder.ASC,
      SortOrder.ASC);
    test(element, length, baseType, null, null, PInteger.INSTANCE, null, null, e, SortOrder.ASC,
      SortOrder.DESC);
  ...
  public void testForFloat() throws SQLException {
    ...
    PhoenixArray e = new PhoenixArray.PrimitiveFloatPhoenixArray(baseType,
      new Object[] { (float) 5.6, (float) 5.6, (float) 5.6 });
    test(element, length, baseType, null, null, PInteger.INSTANCE, null, null, e, SortOrder.ASC,
      SortOrder.ASC);
    test(element, length, baseType, null, null, PInteger.INSTANCE, null, null, e, SortOrder.ASC,
      SortOrder.DESC);
  ...
  public void testForSmallint() throws SQLException {
    ...
    PhoenixArray e = new PhoenixArray.PrimitiveShortPhoenixArray(baseType,
      new Object[] { (short) 5, (short) 5, (short) 5 });
    test(element, length, baseType, null, null, PInteger.INSTANCE, null, null, e, SortOrder.ASC,
      SortOrder.ASC);
    test(element, length, baseType, null, null, PInteger.INSTANCE, null, null, e, SortOrder.ASC,
      SortOrder.DESC);
  ...
  public void testForTinyint() throws SQLException {
    ...
    PhoenixArray e = new PhoenixArray.PrimitiveBytePhoenixArray(baseType,
      new Object[] { (byte) 6, (byte) 6, (byte) 6 });
    test(element, length, baseType, null, null, PInteger.INSTANCE, null, null, e, SortOrder.ASC,
      SortOrder.ASC);
    test(element, length, baseType, null, null, PInteger.INSTANCE, null, null, e, SortOrder.ASC,
      SortOrder.DESC);
  ...
  public void testForLong() throws SQLException {
    ...
    PhoenixArray e =
      new PhoenixArray.PrimitiveLongPhoenixArray(baseType, new Object[] { 34567l, 34567l, 34567l });
    test(element, length, baseType, null, null, PInteger.INSTANCE, null, null, e, SortOrder.ASC,
      SortOrder.ASC);
    test(element, length, baseType, null, null, PInteger.INSTANCE, null, null, e, SortOrder.ASC,
      SortOrder.DESC);
  ...
  public void testForDecimal() throws SQLException {
    ...
    PhoenixArray e = new PhoenixArray(baseType, new Object[] { BigDecimal.valueOf(345.67),
      BigDecimal.valueOf(345.67), BigDecimal.valueOf(345.67) });
    test(element, length, baseType, null, null, PInteger.INSTANCE, null, null, e, SortOrder.ASC,
      SortOrder.ASC);
    test(element, length, baseType, null, null, PInteger.INSTANCE, null, null, e, SortOrder.ASC,
      SortOrder.DESC);
  ...
  public void testForDate() throws SQLException {
    ...
    PhoenixArray e =
      new PhoenixArray(baseType, new Object[] { new Date(23), new Date(23), new Date(23) });
    test(element, length, baseType, null, null, PInteger.INSTANCE, null, null, e, SortOrder.ASC,
      SortOrder.ASC);
    test(element, length, baseType, null, null, PInteger.INSTANCE, null, null, e, SortOrder.ASC,
      SortOrder.DESC);
  ...
  public void testForTime() throws SQLException {
    ...
    PhoenixArray e =
      new PhoenixArray(baseType, new Object[] { new Time(23), new Time(23), new Time(23) });
    test(element, length, baseType, null, null, PInteger.INSTANCE, null, null, e, SortOrder.ASC,
      SortOrder.ASC);
    test(element, length, baseType, null, null, PInteger.INSTANCE, null, null, e, SortOrder.ASC,
      SortOrder.DESC);
