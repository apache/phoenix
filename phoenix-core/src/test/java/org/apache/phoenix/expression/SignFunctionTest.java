...
public class SignFunctionTest {
  ...
  public void testSignFunction() throws Exception {
    testBatch(
      ...
      PDecimal.INSTANCE, new int[] { 1, 0, -1, 1, -1 });

    testBatch(
      new Float[] { 1.0f, 0.0f, -1.0f, Float.MAX_VALUE, Float.MIN_VALUE, -Float.MAX_VALUE,
        -Float.MIN_VALUE, 123.1234f, -123.1234f },
      PFloat.INSTANCE, new int[] { 1, 0, -1, 1, 1, -1, -1, 1, -1 });

    testBatch(new Float[] { 1.0f, 0.0f, Float.MAX_VALUE, Float.MIN_VALUE, 123.1234f },
      PUnsignedFloat.INSTANCE, new int[] { 1, 0, 1, 1, 1 });

    testBatch(
      new Double[] { 1.0, 0.0, -1.0, Double.MAX_VALUE, Double.MIN_VALUE, -Double.MAX_VALUE,
        -Double.MIN_VALUE, 123.1234, -123.1234 },
      PDouble.INSTANCE, new int[] { 1, 0, -1, 1, 1, -1, -1, 1, -1 });
    ...
    testBatch(new Short[] { (short) 1, (short) 0, (short) -1, Short.MAX_VALUE, Short.MIN_VALUE,
      (short) 123, (short) -123 }, PSmallint.INSTANCE, new int[] { 1, 0, -1, 1, -1, 1, -1 });
