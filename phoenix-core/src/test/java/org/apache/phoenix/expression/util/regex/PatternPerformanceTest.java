...
public class PatternPerformanceTest {
  ...
  private ImmutableBytesWritable[] dataPtr =
    new ImmutableBytesWritable[] { getPtr(data[0]), getPtr(data[1]), getPtr(data[2]) };
  ...
  private void testReplaceAll(ImmutableBytesWritable replacePtr, AbstractBasePattern pattern,
    ...
    for (int i = 0; i < maxTimes; ++i) {
      ...
      if (ENABLE_ASSERT) {
        ...
        assertTrue((i % 3 == 1 && ":".equals(result)) || (i % 3 != 1 && "::".equals(result)));
      }
    }
