...
public class ArrayConcatFunctionTest {
    ...
    private static void test(PhoenixArray array1, PhoenixArray array2, PDataType array1DataType, Integer arr1MaxLen, Integer arr1Scale, PDataType array2DataType, Integer arr2MaxLen, Integer arr2Scale, PhoenixArray expected, SortOrder array1SortOrder, SortOrder array2SortOrder) throws SQLException {
        ...
        array1Literal = new LiteralExpression.BuilderA().setValue(array1).setDataType(array1DataType).setMaxLength(arr1MaxLen).setScale(arr1Scale).setSortOrder(array1SortOrder).setDeterminism(Determinism.ALWAYS).build();
        array2Literal = new LiteralExpression.BuilderA().setValue(array2).setDataType(array2DataType).setMaxLength(arr2MaxLen).setScale(arr2Scale).setSortOrder(array2SortOrder).setDeterminism(Determinism.ALWAYS).build();
    ...
    public void testForCorrectSeparatorBytes1() throws Exception {
        ...
        PhoenixArray arr2 = new PhoenixArray(base, o2);
        LiteralExpression array1Literal, array2Literal;
        array1Literal = new LiteralExpression.BuilderA().setValue(arr1).setDataType(type).setSortOrder(SortOrder.ASC).setDeterminism(Determinism.ALWAYS).build();
        array2Literal = new LiteralExpression.BuilderA().setValue(arr2).setDataType(type).setSortOrder(SortOrder.ASC).setDeterminism(Determinism.ALWAYS).build();
    ...
    public void testForCorrectSeparatorBytes2() throws Exception {
        ...
        LiteralExpression array1Literal, array2Literal;
        array1Literal = new LiteralExpression.BuilderA().setValue(arr1).setDataType(type).setSortOrder(SortOrder.ASC).setDeterminism(Determinism.ALWAYS).build();
        array2Literal = new LiteralExpression.BuilderA().setValue(arr2).setDataType(type).setSortOrder(SortOrder.DESC).setDeterminism(Determinism.ALWAYS).build();
        List<Expression> expressions = Lists.newArrayList((Expression) array1Literal);
        expressions.add(array2Literal);
    ...
    public void testForCorrectSeparatorBytes3() throws Exception {
        ...
        PhoenixArray arr2 = new PhoenixArray(base, o2);
        LiteralExpression array1Literal, array2Literal;
        array1Literal = new LiteralExpression.BuilderA().setValue(arr1).setDataType(type).setSortOrder(SortOrder.DESC).setDeterminism(Determinism.ALWAYS).build();
        array2Literal = new LiteralExpression.BuilderA().setValue(arr2).setDataType(type).setSortOrder(SortOrder.DESC).setDeterminism(Determinism.ALWAYS).build();
        List<Expression> expressions = Lists.newArrayList((Expression) array1Literal);
        expressions.add(array2Literal);
