...
public class ArrayPrependFunctionTest {
  ...
  private static void test(PhoenixArray array, Object element, PDataType arrayDataType,
    Integer arrMaxLen, Integer arrScale, PDataType elementDataType, Integer elemMaxLen,
    Integer elemScale, PhoenixArray expected, SortOrder arraySortOrder, SortOrder elementSortOrder)
    throws SQLException {
  ...
  public void testArrayPrependFunction6() throws Exception {
    ...
    Object[] o2 = new Object[] { new Float(8.9), new Float(2.3), new Float(7.9), new Float(-9.6),
      new Float(2.3) };
    Object element = 8.9;
  ...
  public void testArrayPrependFunction11() throws Exception {
    Object[] o = new Object[] { BigDecimal.valueOf(2345), BigDecimal.valueOf(-23.45),
      BigDecimal.valueOf(785) };
    Object[] o2 = new Object[] { BigDecimal.valueOf(-19), BigDecimal.valueOf(2345),
  ...
  public void testArrayPrependFunction12() throws Exception {
    ...
    PhoenixArray arr = new PhoenixArray(baseType, o);
    PhoenixArray expected = new PhoenixArray(baseType, o2);
    test(arr, date, PDataType.fromTypeId(baseType.getSqlType() + PDataType.ARRAY_TYPE_BASE), null,
      null, baseType, null, null, expected, SortOrder.ASC, SortOrder.ASC);
  }
  ...
  public void testArrayPrependFunction13() throws Exception {
    ...
    PhoenixArray arr = new PhoenixArray(baseType, o);
    PhoenixArray expected = new PhoenixArray(baseType, o2);
    test(arr, time, PDataType.fromTypeId(baseType.getSqlType() + PDataType.ARRAY_TYPE_BASE), null,
      null, baseType, null, null, expected, SortOrder.ASC, SortOrder.ASC);
  }
  ...
  public void testArrayPrependFunction14() throws Exception {
    ...
    PhoenixArray arr = new PhoenixArray(baseType, o);
    PhoenixArray expected = new PhoenixArray(baseType, o2);
    test(arr, timestamp, PDataType.fromTypeId(baseType.getSqlType() + PDataType.ARRAY_TYPE_BASE),
      null, null, baseType, null, null, expected, SortOrder.ASC, SortOrder.ASC);
  }
  ...
  public void testArrayPrependFunction15() throws Exception {
    ...
    PhoenixArray expected = new PhoenixArray.PrimitiveIntPhoenixArray(baseType, o2);
    test(arr, element, PDataType.fromTypeId(baseType.getSqlType() + PDataType.ARRAY_TYPE_BASE),
      null, null, baseType, null, null, expected, SortOrder.DESC, SortOrder.ASC);
  }
  ...
  public void testArrayPrependFunction16() throws Exception {
    ...
    PhoenixArray expected = new PhoenixArray.PrimitiveIntPhoenixArray(baseType, o2);
    test(arr, element, PDataType.fromTypeId(baseType.getSqlType() + PDataType.ARRAY_TYPE_BASE),
      null, null, baseType, null, null, expected, SortOrder.DESC, SortOrder.DESC);
  }
  ...
  public void testArrayPrependFunction17() throws Exception {
    ...
    PhoenixArray expected = new PhoenixArray.PrimitiveIntPhoenixArray(baseType, o2);
    test(arr, element, PDataType.fromTypeId(baseType.getSqlType() + PDataType.ARRAY_TYPE_BASE),
      null, null, baseType, null, null, expected, SortOrder.ASC, SortOrder.DESC);
  }
  ...
  public void testArrayPrependFunction18() throws Exception {
    ...
    PhoenixArray arr = new PhoenixArray(baseType, o);
    PhoenixArray expected = new PhoenixArray(baseType, o2);
    test(arr, element, PDataType.fromTypeId(baseType.getSqlType() + PDataType.ARRAY_TYPE_BASE), 4,
      null, baseType, 1, null, expected, SortOrder.ASC, SortOrder.DESC);
  }
  ...
  public void testArrayPrependFunction19() throws Exception {
    ...
    PhoenixArray expected = new PhoenixArray(baseType, o2);
    test(arr, element, PDataType.fromTypeId(baseType.getSqlType() + PDataType.ARRAY_TYPE_BASE), 4,
      null, baseType, 1, null, expected, SortOrder.DESC, SortOrder.ASC);
  }
  ...
  public void testArrayPrependFunction20() throws Exception {
    ...
    PhoenixArray expected = new PhoenixArray(baseType, o2);
    test(arr, element, PDataType.fromTypeId(baseType.getSqlType() + PDataType.ARRAY_TYPE_BASE), 4,
      null, baseType, 1, null, expected, SortOrder.DESC, SortOrder.DESC);
  }
  ...
  public void testArrayPrependFunction22() throws Exception {
    ...
    byte[][] o2 = new byte[][] { new byte[] { 5, 6 }, new byte[] { 2, 0, 3 }, new byte[] { 42, 3 },
      new byte[] { 5, 3 }, new byte[] { 6, 3 }, new byte[] { 2, 5 } };
    ...
    PhoenixArray expected = new PhoenixArray(baseType, o2);
    test(arr, element, PDataType.fromTypeId(baseType.getSqlType() + PDataType.ARRAY_TYPE_BASE),
      null, null, baseType, 1, null, expected, SortOrder.ASC, SortOrder.DESC);
  }

  @Test
  public void testArrayPrependFunction23() throws Exception {
    byte[][] o = new byte[][] { new byte[] { 2, 3 }, new byte[] { 42, 3 }, new byte[] { 5, 3 },
      new byte[] { 6, 3 }, new byte[] { 2, 5 } };
    byte[][] o2 = new byte[][] { new byte[] { 5, 6 }, new byte[] { 2, 3 }, new byte[] { 42, 3 },
      new byte[] { 5, 3 }, new byte[] { 6, 3 }, new byte[] { 2, 5 } };
    byte[] element = new byte[] { 5, 6 };
    ...
    PhoenixArray arr = new PhoenixArray(baseType, o);
    PhoenixArray expected = new PhoenixArray(baseType, o2);
    test(arr, element, PDataType.fromTypeId(baseType.getSqlType() + PDataType.ARRAY_TYPE_BASE), 2,
      null, baseType, 1, null, expected, SortOrder.ASC, SortOrder.DESC);
  }

  @Test
  public void testArrayPrependFunction24() throws Exception {
    byte[][] o = new byte[][] { new byte[] { 2, 0 }, new byte[] { 13, 3 }, new byte[] { 5, 3 },
      new byte[] { 6, 3 }, new byte[] { 2, 5 } };
    byte[][] o2 = new byte[][] { new byte[] { 5, 6 }, new byte[] { 2, 0 }, new byte[] { 13, 3 },
      new byte[] { 5, 3 }, new byte[] { 6, 3 }, new byte[] { 2, 5 } };
    byte[] element = new byte[] { 5, 6 };
    PDataType baseType = PBinary.INSTANCE;
    ...
    PhoenixArray arr = new PhoenixArray(baseType, o);
    PhoenixArray expected = new PhoenixArray(baseType, o2);
    test(arr, element, PDataType.fromTypeId(baseType.getSqlType() + PDataType.ARRAY_TYPE_BASE), 3,
      null, baseType, 1, null, expected, SortOrder.ASC, SortOrder.DESC);
  }
  ...
  public void testForCorrectSeparatorBytes1() throws Exception {
    ...
    PhoenixArray arr = new PhoenixArray(baseType, o);
    LiteralExpression arrayLiteral, elementLiteral;
    arrayLiteral = LiteralExpression.newConstant(arr, PVarcharArray.INSTANCE, null, null,
      SortOrder.ASC, Determinism.ALWAYS);
    elementLiteral = LiteralExpression.newConstant(element, baseType, null, null, SortOrder.ASC,
      Determinism.ALWAYS);
    ...
    ImmutableBytesWritable ptr = new ImmutableBytesWritable();
    arrayPrependFunction.evaluate(null, ptr);
    byte[] expected = new byte[] { 100, 0, 97, 0, 98, 0, 99, 0, 0, 0, -128, 1, -128, 3, -128, 5,
      -128, 7, 0, 0, 0, 10, 0, 0, 0, 4, 1 };
  ...
  public void testForCorrectSeparatorBytes2() throws Exception {
    ...
    ImmutableBytesWritable ptr = new ImmutableBytesWritable();
    arrayPrependFunction.evaluate(null, ptr);
    byte[] expected = new byte[] { -101, -1, -98, -1, -99, -1, -100, -1, -1, -1, -128, 1, -128, 3,
      -128, 5, -128, 7, 0, 0, 0, 10, 0, 0, 0, 4, 1 };
    assertArrayEquals(expected, ptr.get());
  }
  ...
  public void testForCorrectSeparatorBytes3() throws Exception {
    ...
    ImmutableBytesWritable ptr = new ImmutableBytesWritable();
    arrayPrependFunction.evaluate(null, ptr);
    byte[] expected = new byte[] { -101, -1, -98, -1, 0, -2, -100, -1, -1, -1, -128, 1, -128, 3,
      -128, 5, -128, 5, -128, 7, 0, 0, 0, 10, 0, 0, 0, 5, 1 };
    assertArrayEquals(expected, ptr.get());
  }
}
