...
public class ArithmeticOperationTest {
  ...
  public void testDecimalAddition() throws Exception {
    ...
    op1 = LiteralExpression.newConstant(new BigDecimal("1234567890123456789012345678901"),
      PDecimal.INSTANCE, 31, 0);
    ...
    // Exceeds precision.
    op1 = LiteralExpression.newConstant(new BigDecimal("99999999999999999999999999999999999999"),
      PDecimal.INSTANCE, 38, 0);
    ...
    e = new DecimalAddExpression(children);
    assertEqualValue(e, PDecimal.INSTANCE,
      new BigDecimal("99999999999999999999999999999999999999"));

    // Exceeds scale.
    op1 = LiteralExpression.newConstant(new BigDecimal("12345678901234567890123456789012345678"),
      PDecimal.INSTANCE, 38, 0);
    op2 = LiteralExpression.newConstant(new BigDecimal("123.45"), PDecimal.INSTANCE, 5, 2);
    children = Arrays.<Expression> asList(op1, op2);
    e = new DecimalAddExpression(children);
  ...
  public void testDecimalDivision() throws Exception {
    ...
    // PhoenixResultSet.getBigDecimal, the case to (BigDecimal) actually cause the scale to be
    // eradicated. As
    ...
    e = new DecimalDivideExpression(children);
    assertEqualValue(e, PDecimal.INSTANCE,
      new BigDecimal("3.3333333333333333333333333333333333333"));
  }
  ...
  public void testPerInvocationClone() throws Exception {
    ...
    e4 = new DoubleAddExpression(Arrays.<Expression> asList(
      new RandomFunction(Arrays.<Expression> asList(LiteralExpression.newConstant(null))), e3));
    ...
    e4 = new DoubleAddExpression(Arrays.<Expression> asList(
      new RandomFunction(Arrays.<Expression> asList(LiteralExpression.newConstant(1))), e3));
