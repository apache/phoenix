...
public class AndExpressionTest {
  ...
  private Cell createCell(String name, Boolean value) {
    ...
    return CellUtil.createCell(Bytes.toBytes("row"), QueryConstants.DEFAULT_COLUMN_FAMILY_BYTES,
      Bytes.toBytes(name), 1, KeyValue.Type.Put.getCode(), valueBytes);
  }
  ...
  public void testTruthTable() {
    ...
    Boolean[][] testCases = new Boolean[][] {
      ...
      { false, false, true, true, false, }, { true, null, false, false, null, },
      { false, null, true, false, false, }, { null, null, false, false, null, }, };
