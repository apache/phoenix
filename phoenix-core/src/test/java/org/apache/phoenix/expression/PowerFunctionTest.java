...
public class PowerFunctionTest {
  ...
  private static boolean testExpression(LiteralExpression literal, LiteralExpression literal2,
    ...
    if (ret15) {
      Double result =
        (Double) powerFunction15.getDataType().toObject(ptr, powerFunction15.getSortOrder());
    ...
    if (ret2) {
      Double result =
        (Double) powerFunction2.getDataType().toObject(ptr, powerFunction2.getSortOrder());
    ...
    if (ret3) {
      Double result =
        (Double) powerFunction3.getDataType().toObject(ptr, powerFunction3.getSortOrder());
  ...
  private static void test(Number value, PNumericType dataType, double exptFor15, double exptFor2,
    double exptFor3) throws SQLException {
