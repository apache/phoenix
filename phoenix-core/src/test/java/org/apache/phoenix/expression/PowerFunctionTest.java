...
public class PowerFunctionTest {
    ...
    private static boolean testExpression(LiteralExpression literal, LiteralExpression literal2,
            ...
            throws SQLException {
        List<Expression> expressions15 = Lists.newArrayList(literal, new LiteralExpression.Builder().setValue(1.5).build());
        List<Expression> expressions2 = Lists.newArrayList(literal2, new LiteralExpression.Builder().setValue(2).build());
        List<Expression> expressions3 = Lists.newArrayList(literal3, new LiteralExpression.Builder().setValue(3).build());
