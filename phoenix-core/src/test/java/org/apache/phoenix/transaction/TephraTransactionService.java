...
public class TephraTransactionService implements PhoenixTransactionService {
  ...
  public static TephraTransactionService startAndInjectTephraTransactionService(
    TephraTransactionProvider transactionProvider, Configuration config, ConnectionInfo connInfo,
    int port) {
    ...
    ZKClientService zkClient =
      ZKClientServices
        .delegate(
          ZKClients
            .reWatchOnExpire(ZKClients.retryOnFailure(
    ...
    TransactionManager txManager =
      new TransactionManager(config, new HDFSTransactionStateStorage(config,
