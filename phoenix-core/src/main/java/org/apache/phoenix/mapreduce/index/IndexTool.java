...
public class IndexTool extends Configured implements Tool {
  ...
  public CommandLine parseOptions(String[] args) {
    ...
    if (
      (cmdLine.hasOption(START_TIME_OPTION.getOpt())
        || cmdLine.hasOption(RETRY_VERIFY_OPTION.getOpt()))
    ...
    private long getMaxRebuildAsyncDate(String schemaName, List<String> disableIndexes)
      ...
      try (
        ResultSet rs = connection.createStatement()
          .executeQuery("SELECT MAX(" + ASYNC_REBUILD_TIMESTAMP + "),MAX(" + INDEX_DISABLE_TIMESTAMP
  ...
  private void setupIndexAndDataTable(Connection connection) throws SQLException, IOException {
    ...
    pIndexTable =
      PhoenixRuntime.getTable(connection, SchemaUtil.getQualifiedTableName(schemaName, indexTable));
