...
public class TephraTransactionProvider implements PhoenixTransactionProvider {
  ...
  public PhoenixTransactionClient getTransactionClient(Configuration config,
    ...
    int timeOut =
      config.getInt(HConstants.ZK_SESSION_TIMEOUT, HConstants.DEFAULT_ZK_SESSION_TIMEOUT);
    ...
    PooledClientProvider pooledClientProvider =
      new PooledClientProvider(config, zkDiscoveryService);
