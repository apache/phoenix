...
public class PhoenixStatement implements Statement, SQLCloseable, org.apache.phoenix.jdbc.Jdbc7Shim.Statement {
    ...
    private int getDefaultQueryTimeout() {
        ...
        return connection==null ? (QueryServicesOptions.DEFAULT_THREAD_TIMEOUT_MS + 999)/1000 : (connection.getQueryServices().getProps().getInt(QueryServices.THREAD_TIMEOUT_MS_ATTRIB, 
