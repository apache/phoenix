...
public class ZKConnectionInfo extends ConnectionInfo {
    ...
    private final static String ZK_REGISTRY_NAME = "org.apache.hadoop.hbase.client.ZKConnectionRegistry";
    ...
    public boolean equals(Object obj) {
        ...
        if (zkHosts == null) {
            if (other.zkHosts != null) return false;
        } else if (!zkHosts.equals(other.zkHosts)) return false;
        //Port is already normalized into zkHosts
        if (zkRootNode == null) {
            if (other.zkRootNode != null) return false;
        } else if (!zkRootNode.equals(other.zkRootNode)) return false;
        return true;
    }
    ...
    protected static class Builder extends ConnectionInfo.Builder {
        ...
        private void parse() throws SQLException {
            ...
            while (tokenizer.hasMoreTokens() &&
                    !(token=tokenizer.nextToken()).equals(TERMINATOR) && nTokens < tokens.length) {
            ...
            if (zkHosts == null) {
                ...
                if (zkHosts == null) {
                    throw getMalFormedUrlException(
                        "Quorum not specified and hbase.client.zookeeper.quorum is not set in configuration : "
                                + url);
                }
            } else {
    ...
    public static boolean isZK(Configuration config) {
        ...
        return config != null && ZK_REGISTRY_NAME.equals(
            config.get(CLIENT_CONNECTION_REGISTRY_IMPL_CONF_KEY));
    }
}
