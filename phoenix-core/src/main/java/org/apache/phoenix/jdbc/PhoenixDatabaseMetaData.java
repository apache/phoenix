...
public class PhoenixDatabaseMetaData implements DatabaseMetaData {
  ...
  // The phoenix ttl high watermark if set indicates the timestamp used for determining the expired
  // rows.
  ...
  PhoenixDatabaseMetaData(PhoenixConnection connection) throws SQLException {
    this.emptyResultSet = new PhoenixResultSet(ResultIterator.EMPTY_ITERATOR,
      RowProjector.EMPTY_PROJECTOR, new StatementContext(new PhoenixStatement(connection), false));
    ...
    try {
      ...
      while (rs.next()) {
        ...
        for (PColumn column : columns) {
          ...
          // REMARKS
          cells
            .add(PhoenixKeyValueUtil.newKeyValue(rowKey, TABLE_FAMILY_BYTES, Bytes.toBytes(REMARKS),
          ...
          cells
            .add(PhoenixKeyValueUtil.newKeyValue(rowKey, TABLE_FAMILY_BYTES, ORDINAL_POSITION_BYTES,
          ...
          // IS_NULLABLE
          cells.add(
            PhoenixKeyValueUtil.newKeyValue(rowKey, TABLE_FAMILY_BYTES, Bytes.toBytes(IS_NULLABLE),
          ...
          // SCOPE_SCHEMA
          cells.add(
            PhoenixKeyValueUtil.newKeyValue(rowKey, TABLE_FAMILY_BYTES, Bytes.toBytes(SCOPE_SCHEMA),
              MetaDataProtocol.MIN_TABLE_TIMESTAMP, ByteUtil.EMPTY_BYTE_ARRAY));
          // SCOPE_TABLE
          cells.add(
            PhoenixKeyValueUtil.newKeyValue(rowKey, TABLE_FAMILY_BYTES, Bytes.toBytes(SCOPE_TABLE),
              MetaDataProtocol.MIN_TABLE_TIMESTAMP, ByteUtil.EMPTY_BYTE_ARRAY));
          // SOURCE_DATA_TYPE
          cells.add(PhoenixKeyValueUtil.newKeyValue(rowKey, TABLE_FAMILY_BYTES,
          ...
          cells.add(PhoenixKeyValueUtil.newKeyValue(rowKey, TABLE_FAMILY_BYTES, ARRAY_SIZE_BYTES,
            ...
            column.getArraySize() != null
              ...
              : ByteUtil.EMPTY_BYTE_ARRAY));
          // COLUMN_FAMILY
          cells.add(PhoenixKeyValueUtil.newKeyValue(rowKey, TABLE_FAMILY_BYTES, COLUMN_FAMILY_BYTES,
            MetaDataProtocol.MIN_TABLE_TIMESTAMP,
          ...
          cells.add(PhoenixKeyValueUtil.newKeyValue(rowKey, TABLE_FAMILY_BYTES, VIEW_CONSTANT_BYTES,
            ...
            column.getViewConstant() != null
              ...
              : ByteUtil.EMPTY_BYTE_ARRAY));
          // MULTI_TENANT
          cells.add(PhoenixKeyValueUtil.newKeyValue(rowKey, TABLE_FAMILY_BYTES, MULTI_TENANT_BYTES,
            MetaDataProtocol.MIN_TABLE_TIMESTAMP,
      ...
      while (rs.next()) {
        ...
        for (PColumn column : sorderPkColumns) {
          ...
          cells.add(PhoenixKeyValueUtil.newKeyValue(rowKey, TABLE_FAMILY_BYTES, PK_NAME_BYTES,
            MetaDataProtocol.MIN_TABLE_TIMESTAMP,
            table.getPKName() != null ? table.getPKName().getBytes() : ByteUtil.EMPTY_BYTE_ARRAY));
          // ASC_OR_DESC
  ...
  public ResultSet getTableTypes() throws SQLException {
    return new PhoenixResultSet(new MaterializedResultIterator(TABLE_TYPE_TUPLES),
      TABLE_TYPE_ROW_PROJECTOR, new StatementContext(new PhoenixStatement(connection), false));
  }
