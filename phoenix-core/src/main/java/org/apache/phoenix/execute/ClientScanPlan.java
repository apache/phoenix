...
public class ClientScanPlan extends ClientProcessingPlan {
    ...
    public ResultIterator iterator(ParallelScanGrouper scanGrouper, Scan scan) throws SQLException {
        ...
        if (!orderBy.getOrderByExpressions().isEmpty()) { // TopN
            ...
            iterator = new OrderedResultIterator(iterator, orderBy.getOrderByExpressions(), thresholdBytes, memoryManager,
                    spoolDirectory, limit, offset, projector.getEstimatedRowByteSize());
        } else {
            if (offset != null) {
