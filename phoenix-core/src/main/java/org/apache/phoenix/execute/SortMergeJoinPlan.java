...
public class SortMergeJoinPlan implements QueryPlan {
  ...
  public SortMergeJoinPlan(StatementContext context, FilterableStatement statement, TableRef table,
    ...
    this.thresholdBytes = context.getConnection().getQueryServices().getProps().getLong(
  ...
  private static List<OrderByExpression> compileOrderByNodes(List<OrderByNode> orderByNodes,
