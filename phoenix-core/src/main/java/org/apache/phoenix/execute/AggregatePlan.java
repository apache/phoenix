...
public class AggregatePlan extends BaseQueryPlan {
  ...
  protected ResultIterator newIterator(ParallelScanGrouper scanGrouper, Scan scan,
    ...
    if (groupBy.isEmpty()) {
      ...
      GroupedAggregateRegionObserver.serializeIntoScan(scan, groupBy.getScanAttribName(),
    ...
    if (orderBy.getOrderByExpressions().isEmpty()) {
      ...
      long thresholdBytes = context.getConnection().getQueryServices().getProps().getLong(
