...
public enum SQLExceptionCode {
    ...
    COLUMN_FAMILY_NOT_ALLOWED_FOR_PROPERTY(1050, "43A07", "Setting any of the following properties: " + MetaDataUtil.PROPERTIES_TO_KEEP_IN_SYNC_AMONG_COL_FAMS_AND_INDEXES.toString() +
    ...
    CANNOT_SET_OR_ALTER_PROPERTY_FOR_INDEX(1094, "44A25", "Cannot set or alter the following properties on an index: " + MetaDataUtil.PROPERTIES_TO_KEEP_IN_SYNC_AMONG_COL_FAMS_AND_INDEXES.toString()),
