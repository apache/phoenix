...
public enum SQLExceptionCode {
  ...
  PHOENIX_TTL_SUPPORTED_FOR_VIEWS_ONLY(10951, "44A32",
    PhoenixDatabaseMetaData.PHOENIX_TTL + " property can only be set for views"),
  CANNOT_SET_OR_ALTER_PHOENIX_TTL_FOR_TABLE_WITH_TTL(10952, "44A33",
    "Cannot set or alter " + PhoenixDatabaseMetaData.PHOENIX_TTL
      + " property on an table with TTL,"),
  ...
  CANNOT_SET_OR_ALTER_PHOENIX_TTL(10953, "44A35",
    "Cannot set or alter " + PhoenixDatabaseMetaData.PHOENIX_TTL
      + " property on an view when parent/child view has PHOENIX_TTL set,"),
