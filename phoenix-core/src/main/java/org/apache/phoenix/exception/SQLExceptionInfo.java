...
public class SQLExceptionInfo {
  ...
  public String toString() {
    ...
    if (maxMutationSize != 0) {
      ...
      builder.append(" ").append(MAX_MUTATION_SIZE_BYTES).append("=").append(maxMutationSizeBytes);
      builder.append(" ").append(MUTATION_SIZE_BYTES).append("=").append(mutationSizeBytes);
    }
    if (maxPhoenixColumnSizeBytes != 0) {
      builder.append(" ").append(MAX_PHOENIX_COLUMN_SIZE_BYTES).append("=")
        .append(maxPhoenixColumnSizeBytes);
      builder.append(" ").append(PHOENIX_COLUMN_SIZE_BYTES).append("=")
        .append(phoenixColumnSizeBytes);
    }
    return builder.toString();
  }
