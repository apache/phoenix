...
public interface QueryServices extends SQLCloseable {
    ...
    public static final String QUERY_SERVER_DOAS_ENABLED_ATTRIB = "phoenix.queryserver.doAs.enabled";
    public static final String QUERY_SERVER_DOAS_PARAM = "phoenix.queryserver.doAs.param";
