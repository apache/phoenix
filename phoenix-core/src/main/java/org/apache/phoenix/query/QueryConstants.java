...
public interface QueryConstants {
  ...
  String CREATE_TABLE_METADATA =
    ...
    // PK columns
      ...
      + " BIGINT,\n" + LAST_DDL_TIMESTAMP + " BIGINT, " + CHANGE_DETECTION_ENABLED + " BOOLEAN, " +
      ...
      + TRANSACTION_PROVIDER + " TINYINT, " + "CONSTRAINT " + SYSTEM_TABLE_PK_NAME
      + " PRIMARY KEY (" + TENANT_ID + "," + TABLE_SCHEM + "," + TABLE_NAME + "," + COLUMN_NAME
  ...
  String CREATE_TASK_METADATA =
    ...
    // PK columns
      ...
      TableDescriptorBuilder.SPLIT_POLICY + "='" + SystemTaskSplitPolicy.class.getName() + "',\n"
