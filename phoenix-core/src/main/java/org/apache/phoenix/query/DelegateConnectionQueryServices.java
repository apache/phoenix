...
public class DelegateConnectionQueryServices extends DelegateQueryServices
  ...
  public void removeColumn(PName tenantId, String tableName, List<PColumn> columnsToRemove,
    ...
    getDelegate().removeColumn(tenantId, tableName, columnsToRemove, tableTimeStamp, tableSeqNum,
      resolvedTime);
  }
  ...
  public MetaDataMutationResult getTable(PName tenantId, byte[] schemaBytes, byte[] tableBytes,
    ...
    return getDelegate().getTable(tenantId, schemaBytes, tableBytes, tableTimestamp,
      clientTimestamp);
  }
  ...
  @Override
  public MetaDataMutationResult dropTable(List<Mutation> tabeMetaData, PTableType tableType,
  ...
  public MetaDataMutationResult addColumn(List<Mutation> tableMetaData, PTable table,
    PTable parentTable, Map<String, List<Pair<String, Object>>> properties,
    Set<String> colFamiliesForPColumnsToBeAdded, List<PColumn> columns) throws SQLException {
    return getDelegate().addColumn(tableMetaData, table, parentTable, properties,
      colFamiliesForPColumnsToBeAdded, columns);
  }

  @Override
  public MetaDataMutationResult dropColumn(List<Mutation> tabeMetaData, PTableType tableType,
  ...
  public long createSequence(String tenantId, String schemaName, String sequenceName,
    ...
    return getDelegate().createSequence(tenantId, schemaName, sequenceName, startWith, incrementBy,
      cacheSize, minValue, maxValue, cycle, timestamp);
  }
  ...
  public boolean writeMutexCell(String tenantId, String schemaName, String tableName,
    ...
    return getDelegate().writeMutexCell(tenantId, schemaName, tableName, columnName, familyName);
  }
