...
public class ConnectionQueryServicesImpl extends DelegateQueryServices implements ConnectionQueryServices {
    ...
    private void clearCacheForTable(final byte[] tenantId, final byte[] schemaName, final byte[] tableName)
            throws SQLException {
        ...
        try {
            ...
            try {
                htable.coprocessorService(MetaDataService.class, HConstants.EMPTY_START_ROW,
                        HConstants.EMPTY_END_ROW, new Batch.Call<MetaDataService, ClearCacheForTableResponse>() {
                    @Override
                    public ClearCacheForTableResponse call(MetaDataService instance) throws IOException {
                        ServerRpcController controller = new ServerRpcController();
                        BlockingRpcCallback<ClearCacheForTableResponse> rpcCallback =
                                new BlockingRpcCallback<ClearCacheForTableResponse>();
