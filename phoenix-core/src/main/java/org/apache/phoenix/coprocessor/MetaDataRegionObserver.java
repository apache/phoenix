...
public class MetaDataRegionObserver extends BaseRegionObserver {
    ...
    private long rebuildIndexTimeInterval = 10000;
    ...
    public void start(CoprocessorEnvironment env) throws IOException {
      ...
      enableRebuildIndex = env.getConfiguration().getBoolean(QueryServices.INDEX_FAILURE_HANDLING_REBUILD, 
            QueryServicesOptions.DEFAULT_INDEX_FAILURE_HANDLING_REBUILD);
      rebuildIndexTimeInterval = env.getConfiguration().getLong(QueryServices.INDEX_FAILURE_HANDLING_REBUILD_INTERVAL, 
      ...
      public void run() {
        ...
        try {
          ...
          do {
            ...
            if(!MetaDataClient.tableRegionsOnline(this.env.getConfiguration(), indexPTable)) {
            ...
            long overlapTime = env.getConfiguration().getLong(QueryServices.INDEX_FAILURE_HANDLING_REBUILD_OVERLAP_TIME,
            ...
            LOG.info("Starting to build index=" + indexPTable.getName() + " from timestamp="
                + timeStamp);
            client.buildPartialIndexFromTimeStamp(indexPTable, new TableRef(dataPTable), timeStamp);
