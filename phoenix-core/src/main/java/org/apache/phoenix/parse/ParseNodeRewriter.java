...
public class ParseNodeRewriter extends TraverseAllParseNodeVisitor<ParseNode> {
	...
	@Override
	public ParseNode visitLeave(JsonPathAsTextParseNode node, List<ParseNode> nodes)
			throws SQLException {
		return leaveCompoundNode(node, nodes, new CompoundNodeFactory() {
            @Override
            public ParseNode createNode(List<ParseNode> children) {
                return NODE_FACTORY.jsonPathT(children.get(0), children.get(1));
            }
        });
	}
	...
	@Override
	public ParseNode visitLeave(JsonSupersetParseNode node, List<ParseNode> nodes)
			throws SQLException {
		return leaveCompoundNode(node, nodes, new CompoundNodeFactory() {
            @Override
            public ParseNode createNode(List<ParseNode> children) {
	...
	@Override
	public ParseNode visitLeave(JsonSubsetParseNode node, List<ParseNode> nodes)
			throws SQLException {
		return leaveCompoundNode(node, nodes, new CompoundNodeFactory() {
            @Override
            public ParseNode createNode(List<ParseNode> children) {
	...
	@Override
	public ParseNode visitLeave(JsonSingleKeySearchParseNode node,
			List<ParseNode> nodes) throws SQLException {
		return leaveCompoundNode(node, nodes, new CompoundNodeFactory() {
            @Override
            public ParseNode createNode(List<ParseNode> children) {
	...
	@Override
	public ParseNode visitLeave(JsonMultiKeySearchOrParseNode node,
			List<ParseNode> nodes) throws SQLException {
		return leaveCompoundNode(node, nodes, new CompoundNodeFactory() {
            @Override
            public ParseNode createNode(List<ParseNode> children) {
	...
	@Override
	public ParseNode visitLeave(JsonMultiKeySeatchAndParseNode node,
			List<ParseNode> nodes) throws SQLException {
		return leaveCompoundNode(node, nodes, new CompoundNodeFactory() {
            @Override
            public ParseNode createNode(List<ParseNode> children) {
