...
public class ParallelIterators extends ExplainTable implements ResultIterators {
    ...
    private boolean useStats() {
        ...
        /*
         * Don't use guide posts if: 1) We're doing a point lookup, as HBase is fast enough at those to not need them to be further
         * parallelized. TODO: pref test to verify 2) We're collecting stats, as in this case we need to scan entire regions worth of data
