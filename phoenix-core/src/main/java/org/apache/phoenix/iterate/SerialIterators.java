    ...
    private class SerialIterator implements PeekingResultIterator {
        ...
        private PeekingResultIterator nextIterator() throws SQLException {
            ...
            while (index < scans.size()) {
                ...
                TableResultIterator itr = new TableResultIterator(mutationState, currentScan, context.getReadMetricsQueue().allotMetric(SCAN_BYTES, tableName), renewLeaseThreshold, plan, scanGrouper, caches);
