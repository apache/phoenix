...
public class Sequence {
    ...
    private static KeyValue getKeyValue(Result r, KeyValue kv, int cellIndex) {
        ...
        return kvs.length == NUM_SEQUENCE_KEY_VALUES ? kvs[cellIndex] : r.getColumnLatest(kv.getFamily(), kv.getQualifier());
    }
    ...
    public static void replaceLimitReachedKV(List<KeyValue> kvs, KeyValue limitReachedKV) {
    ...
    /**
     * Returns a list of KeyValues for the result row to be returned, adding only those KeyValues in r
    ...
    private static final class SequenceValue {
        ...
        public SequenceValue(Result r, ValueOp op) {
            ...
            this.nextValue = PDataType.LONG.getCodec().decodeLong(currentValueKV.getBuffer(), currentValueKV.getValueOffset(), SortOrder.getDefault());
            ...
            this.cacheSize = PDataType.LONG.getCodec().decodeLong(cacheSizeKV.getBuffer(), cacheSizeKV.getValueOffset(), SortOrder.getDefault());
