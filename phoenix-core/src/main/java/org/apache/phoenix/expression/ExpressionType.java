...
public enum ExpressionType {
    ...
    JsonArrayLengthFunction(JsonArrayLengthFunction.class),
    JsonArrayElementsFunction(JsonArrayElementsFunction.class),
    JsonEachFunction(JsonEachFunction.class),
    JsonObjectKeysFunction(JsonObjectKeysFunction.class),
    JsonPopulateRecordFunction(JsonPopulateRecordFunction.class),
    JsonPopulateRecordSetFunction(JsonPopulateRecordSetFunction.class),
    ToJsonFunction(ToJsonFunction.class),
    ArrayToJsonFunction(ArrayToJsonFunction.class)
    ;
