...
public class ToTimeFunction extends ToDateFunction {
    ...
    public ToTimeFunction(List<Expression> children, String dateFormat, String timeZoneId, ExpressionContext context) throws SQLException {
    ...
    public ToTimeFunction clone(List<Expression> children) {
    	try {
            return new ToTimeFunction(children, dateFormat, timeZoneId, context);
        } catch (Exception e) {
