...
/**
 * 
 * Aggregator that sums BigDecimal values distinct
 *
 */
public class DecimalSumDistinctAggregator extends BaseAggregator {
    private BigDecimal sum = BigDecimal.ZERO;
    private byte[] sumBuffer;
    protected Set<BigDecimal> set = new HashSet<>();

    public DecimalSumDistinctAggregator(SortOrder sortOrder, ImmutableBytesWritable ptr) {
        super(sortOrder);
        if (ptr != null) {
            initBuffer();
    ...
    public String toString() {
        return "DECIMAL DISTINCT SUM [sum=" + sum + "]";
    }
