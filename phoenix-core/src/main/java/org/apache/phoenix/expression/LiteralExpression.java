...
public class LiteralExpression extends BaseTerminalExpression {
    ...
    public static class Builder {
        ...
        /**
         * Build method that either returns static constant LiteralExpressions or routes to initAttributes methods
         * @return LiteralExpression object
         * @throws SQLException
         */
        public LiteralExpression build() throws SQLException{
            if (this.value == null && this.type == null && this.determinism == null && this.maxLength == null && this.scale == null && this.sortOrder == null) {
                return new LiteralExpression(this.initAttributesByteValue());
            } else if (this.type == null && this.byteValue == null && this.maxLength == null && this.scale == null && this.sortOrder == null) {
                ...
                return new LiteralExpression(this.initAttributesSimple());
            } else {
                if (this.determinism == null) {
                    this.determinism = Determinism.ALWAYS;
                }
        ...
        /**
         * Method to initialize/derive attributes for Literal Expressions that have only value and determinism fields
         * (can be null)
         * @return LiteralExpression builder
         */
        private Builder initAttributesSimple() {
            PDataType type = PDataType.fromLiteral(this.value);
            this.byteValue = type.toBytes(this.value);
        ...
        /**
         * Method to initialize attributes for LiteralExpressions that have only byteValue field (can be null)
         * @return LiteralExpression builder
         */
        private Builder initAttributesByteValue() {
         ...
         * @throws SQLException
         */
        private Builder initAttributes() throws SQLException{
            PDataType actualType = PDataType.fromLiteral(this.value);
            this.type = this.type == null ? actualType : this.type;
            try {
                this.value = this.type.toObject(this.value, actualType);
