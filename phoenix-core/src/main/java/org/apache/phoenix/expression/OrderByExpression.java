...
public class OrderByExpression implements Writable {
  ...
  /**
   * If {@link Expression#getSortOrder()} is {@link SortOrder#DESC},the isAscending of returned new
   * is reversed,but isNullsLast is untouched.
   */
  public static OrderByExpression
    convertIfExpressionSortOrderDesc(OrderByExpression orderByExpression) {
    return createByCheckIfExpressionSortOrderDesc(orderByExpression.getExpression(),
      orderByExpression.isNullsLast(), orderByExpression.isAscending());
  }

  /**
   * If {@link Expression#getSortOrder()} is {@link SortOrder#DESC},reverse the isAscending,but
   * isNullsLast is untouched. A typical case is in OrderByCompiler#compile to get the compiled
   * OrderByExpression to used for OrderedResultIterator.
   */
  public static OrderByExpression createByCheckIfExpressionSortOrderDesc(Expression expression,
    boolean isNullsLast, boolean isAscending) {
  ...
  /**
   * If orderByReverse is true, reverse the isNullsLast and isAscending. A typical case is in
   * AggregatePlan.OrderingResultIteratorFactory#newIterator
   */
  public static OrderByExpression createByCheckIfOrderByReverse(Expression expression,
    boolean isNullsLast, boolean isAscending, boolean orderByReverse) {
    if (orderByReverse) {
  ...
  /**
   * Create OrderByExpression from expression,isNullsLast is the default value "false",isAscending
   * is based on {@link Expression#getSortOrder()}. If orderByReverse is true, reverses the
   * isNullsLast and isAscending.
   */
  public static OrderByExpression convertExpressionToOrderByExpression(Expression expression,
    boolean orderByReverse) {
    return convertExpressionToOrderByExpression(expression, null, orderByReverse);
  }

  /**
   * Create OrderByExpression from expression, if the orderPreservingTrackInfo is not null, use
   * isNullsLast and isAscending from orderPreservingTrackInfo. If orderByReverse is true, reverses
   * the isNullsLast and isAscending.
   */
  public static OrderByExpression convertExpressionToOrderByExpression(Expression expression,
    Info orderPreservingTrackInfo, boolean orderByReverse) {
    ...
    return OrderByExpression.createByCheckIfOrderByReverse(expression, isNullsLast, isAscending,
      orderByReverse);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o != null && this.getClass() == o.getClass()) {
      ...
      return isNullsLast == that.isNullsLast && isAscending == that.isAscending
