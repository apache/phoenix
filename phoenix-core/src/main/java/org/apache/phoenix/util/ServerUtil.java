...
public class ServerUtil {
    ...
    public static class ConnectionFactory {
        ...
        private static Map<ConnectionType, HConnection> connections =
                new ConcurrentHashMap<ConnectionType, HConnection>();

        public static HConnection getConnection(final ConnectionType connectionType, final Configuration conf, final HRegionServer server) throws IOException {
