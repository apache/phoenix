...
public class IndexUtil {
  ...
  public static List<Mutation> generateIndexData(final PTable table, PTable index,
    ...
    final KeyValueBuilder kvBuilder, PhoenixConnection connection) throws SQLException {
    try {
  ...
  public static void addTupleAsOneCell(List<Cell> result, Tuple tuple,
    ...
    Cell keyValue = PhoenixKeyValueUtil.newKeyValue(firstCell.getRowArray(),
  ...
  public static PTable getPDataTable(Connection conn, TableDescriptor tableDesc)
    throws SQLException {
  ...
  public static boolean isHintedGlobalIndex(final TableRef tableRef) {
    ...
    return table.getType() == PTableType.INDEX && table.getIndexType() == PTable.IndexType.GLOBAL
      && tableRef.isHinted();
  }
