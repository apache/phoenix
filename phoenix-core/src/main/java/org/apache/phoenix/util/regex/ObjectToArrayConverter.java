...
class ObjectToArrayConverter {
    ...
    private final RegexUpsertExecutor.SimpleDatatypeConversionFunction elementConvertFunction;
    ...
    public ObjectToArrayConverter(Connection conn, PDataType elementDataType) {
        ...
        this.elementConvertFunction =
            new RegexUpsertExecutor.SimpleDatatypeConversionFunction(elementDataType, this.conn);
    }
