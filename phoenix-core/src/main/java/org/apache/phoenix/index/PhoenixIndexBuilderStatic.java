...
public class PhoenixIndexBuilderStatic {
    public static final byte[] ON_DUP_KEY_IGNORE_BYTES = new byte[] {1}; // boolean true
    public static final int ON_DUP_KEY_HEADER_BYTE_SIZE = Bytes.SIZEOF_SHORT + Bytes.SIZEOF_BOOLEAN;
