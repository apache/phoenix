...
/**
 * Note that some tests for concurrentConnections live in PhoenixMetricsIT.java which also test the
 * metric emission
 */
...
public class MaxConcurrentConnectionsIT extends BaseTest {
  ...
  public void testDeleteRuntimeFailureClosesConnections() throws Exception {
    ...
    String ddl = "create table " + tableName
      + "  (i integer not null primary key, j integer) SALT_BUCKETS=256 ";
    ...
    try {
      ...
      assertEquals(String.format("Found %d internal connections still open.", connections), 0,
        connections);
    }
