...
public class MetaDataCachingIT extends BaseTest {
  ...
  private void createTable(Connection conn, String tableName, long updateCacheFrequency)
    throws SQLException {
  ...
  public void testGlobalClientCacheMetrics() throws Exception {
    ...
    assertEquals("Incorrect number of client metadata cache misses", 1,
    ...
    assertEquals("Incorrect number of client metadata cache hits", 3 * numMaxDML * numThreads,
