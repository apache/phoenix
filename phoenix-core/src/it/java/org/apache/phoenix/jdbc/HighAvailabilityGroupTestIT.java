...
public class HighAvailabilityGroupTestIT {
    ...
    public void testConnectToOneClusterShouldNotFailWithDifferentHostOrderJdbcString() throws SQLException {
        ...
        haGroup.connectToOneCluster(jdbcString, clientProperties, haURLInfo);
        verify(DRIVER, times(1)).getConnectionQueryServices(eq(String.format("jdbc:phoenix+rpc:%s", MASTER1)), eq(clientProperties));
    }
    ...
    public void testIsConnectionActive() throws SQLException {
        ...
        PhoenixConnection connection = haGroup.connectToOneCluster(MASTER1, clientProperties, haURLInfo);
...
//    @Test
    public void testNegativeCacheWhenMissingClusterRoleRecords() throws Exception {
        ...
        HighAvailabilityGroup.CURATOR_CACHE.put(HighAvailabilityGroup.generateCacheKey(MASTER2, null), curator);
        HighAvailabilityGroup.CURATOR_CACHE.put(HighAvailabilityGroup.generateCacheKey(MASTER1, null), curator);
