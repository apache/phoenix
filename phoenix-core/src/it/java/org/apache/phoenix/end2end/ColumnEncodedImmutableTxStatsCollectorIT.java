...
public class ColumnEncodedImmutableTxStatsCollectorIT extends StatsCollectorIT {
    ...
    public ColumnEncodedImmutableTxStatsCollectorIT(boolean mutable, boolean transactional, String transactionProvider,
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(
            new Object[][] { { false, true, "TEPHRA", false, true }, { false, true, "TEPHRA", true, true }, });
    }
}
