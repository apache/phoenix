...
public class ExplainPlanWithStatsDisabledIT extends ParallelStatsDisabledIT {
  ...
  public void testBytesRowsForSortMergeJoin() throws Exception {
    String tableA = generateUniqueName();
    String tableB = generateUniqueName();
    String sql = "SELECT /*+ USE_SORT_MERGE_JOIN */ ta.c1.a, ta.c2.b FROM " + tableA + " ta JOIN "
  ...
  public void testEstimatesForUnionWithTablesWithNullAndLargeGpWidth() throws Exception {
    ...
    try (Connection conn = DriverManager.getConnection(getUrl())) {
      ...
      conn.createStatement().execute("CREATE TABLE " + tableWithLargeGPWidth
  ...
  public void testRangeScanWithMetadataLookup() throws Exception {
    ...
    try (Connection conn = DriverManager.getConnection(getUrl(), props)) {
      conn.createStatement().execute(
        "CREATE TABLE " + tableName + "(PK1 VARCHAR NOT NULL, " + "PK2 VARCHAR, COL1 VARCHAR"
      ...
      for (int i = 0; i < 25; i++) {
        String pk1Val = "a" + i;
        conn.createStatement()
          .execute("UPSERT INTO " + tableName + " VALUES ('" + pk1Val + "', 'pk2a', 'col10a')");
        pk1Val = "ab" + i;
        conn.createStatement()
          .execute("UPSERT INTO " + tableName + " VALUES ('" + pk1Val + "', 'pk2ab', 'col10ab')");
      }
      for (int i = 0; i < 25; i++) {
        String pk1Val = "b" + i;
        conn.createStatement()
          .execute("UPSERT INTO " + tableName + " VALUES ('" + pk1Val + "', 'pk2b', 'col10b')");
        pk1Val = "bc" + i;
        conn.createStatement()
          .execute("UPSERT INTO " + tableName + " VALUES ('" + pk1Val + "', 'pk2bc', 'col10bc')");
      }
      for (int i = 0; i < 25; i++) {
        String pk1Val = "c" + i;
        conn.createStatement()
          .execute("UPSERT INTO " + tableName + " VALUES ('" + pk1Val + "', 'pk2c', 'col10c')");
        pk1Val = "cd" + i;
        conn.createStatement()
          .execute("UPSERT INTO " + tableName + " VALUES ('" + pk1Val + "', 'pk2cd', 'col10cd')");
      }
      for (int i = 0; i < 25; i++) {
        String pk1Val = "d" + i;
        conn.createStatement()
          .execute("UPSERT INTO " + tableName + " VALUES ('" + pk1Val + "', 'pk2d', 'col10d')");
        pk1Val = "de" + i;
        conn.createStatement()
          .execute("UPSERT INTO " + tableName + " VALUES ('" + pk1Val + "', 'pk2de', 'col10de')");
      }
      for (int i = 0; i < 25; i++) {
        String pk1Val = "e" + i;
        conn.createStatement()
          .execute("UPSERT INTO " + tableName + " VALUES ('" + pk1Val + "', 'pk2e', 'col10e')");
        pk1Val = "ef" + i;
        conn.createStatement()
          .execute("UPSERT INTO " + tableName + " VALUES ('" + pk1Val + "', 'pk2ef', 'col10ef')");
      }
      conn.commit();
  ...
  public void testMultiTenantWithMetadataLookup() throws Exception {
    ...
    try (Connection conn = DriverManager.getConnection(getUrl(), props)) {
      conn.createStatement()
        .execute("CREATE TABLE " + tableName + "(TENANT_ID VARCHAR NOT NULL, "
      ...
      try (Connection tenantConn = getTenantConnection("ab12")) {
        tenantConn.createStatement()
          .execute("CREATE VIEW " + view01 + " (COL2 VARCHAR) AS SELECT * FROM " + tableName);
        for (int i = 0; i < 25; i++) {
          String pk2Val = "012" + i;
          tenantConn.createStatement().execute("UPSERT INTO " + view01
            + "(PK2, COL1, COL2) VALUES ('" + pk2Val + "', 'col101', 'col201')");
          pk2Val = "ab" + i;
          tenantConn.createStatement().execute("UPSERT INTO " + view01
            + "(PK2, COL1, COL2) VALUES ('" + pk2Val + "', 'col1010', 'col2010')");
        }
        tenantConn.commit();
      }
      ...
      try (Connection tenantConn = getTenantConnection("bc12")) {
        tenantConn.createStatement()
          .execute("CREATE VIEW " + view02 + " (COL2 VARCHAR) AS SELECT * FROM " + tableName);
        for (int i = 0; i < 25; i++) {
          String pk2Val = "012" + i;
          tenantConn.createStatement().execute("UPSERT INTO " + view02
            + "(PK2, COL1, COL2) VALUES ('" + pk2Val + "', 'col101', 'col201')");
          pk2Val = "ab" + i;
          tenantConn.createStatement().execute("UPSERT INTO " + view02
            + "(PK2, COL1, COL2) VALUES ('" + pk2Val + "', 'col1010', 'col2010')");
      ...
      try (Connection tenantConn = getTenantConnection("cd12")) {
        tenantConn.createStatement()
          .execute("CREATE VIEW " + view03 + " (COL2 VARCHAR) AS SELECT * FROM " + tableName);
        for (int i = 0; i < 25; i++) {
          String pk2Val = "012" + i;
          tenantConn.createStatement().execute("UPSERT INTO " + view03
            + "(PK2, COL1, COL2) VALUES ('" + pk2Val + "', 'col101', 'col201')");
          pk2Val = "ab" + i;
          tenantConn.createStatement().execute("UPSERT INTO " + view03
            + "(PK2, COL1, COL2) VALUES ('" + pk2Val + "', 'col1010', 'col2010')");
      ...
      try (Connection tenantConn = getTenantConnection("de12")) {
        tenantConn.createStatement()
          .execute("CREATE VIEW " + view04 + " (COL2 VARCHAR) AS SELECT * FROM " + tableName);
        for (int i = 0; i < 25; i++) {
          String pk2Val = "012" + i;
          tenantConn.createStatement().execute("UPSERT INTO " + view04
            + "(PK2, COL1, COL2) VALUES ('" + pk2Val + "', 'col101', 'col201')");
          pk2Val = "ab" + i;
          tenantConn.createStatement().execute("UPSERT INTO " + view04
            + "(PK2, COL1, COL2) VALUES ('" + pk2Val + "', 'col1010', 'col2010')");
