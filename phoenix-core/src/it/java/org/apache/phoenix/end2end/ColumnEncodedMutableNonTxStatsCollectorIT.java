...
public class ColumnEncodedMutableNonTxStatsCollectorIT extends StatsCollectorIT {
    ...
    public ColumnEncodedMutableNonTxStatsCollectorIT(boolean mutable, boolean transactional, String transactionProvider,
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(
            new Object[][] { { true, false, null, false, true }, { true, false, null, true, true } });
    }
}
