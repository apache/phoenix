...
public class LastValuesFunctionIT extends ParallelStatsDisabledIT {
  ...
  public void simpleTest() throws Exception {
    ...
    ResultSet rs = conn.createStatement()
      .executeQuery("SELECT LAST_VALUES(val, 3) WITHIN GROUP (ORDER BY dates DESC) FROM "
  ...
  public void varcharDatatypeSimpleTest() throws Exception {
    ...
    ResultSet rs = conn.createStatement()
      .executeQuery("SELECT LAST_VALUES(\"value\", 2) WITHIN GROUP (ORDER BY \"DATE\" ASC) FROM "
  ...
  public void offsetValueDescOrder() throws Exception {
    ...
    ResultSet rs = conn.createStatement()
      .executeQuery("SELECT LAST_VALUES(\"value\", 2)  WITHIN GROUP (ORDER BY \"DATE\" DESC) FROM "
        + tableName + " GROUP BY page_id");
  ...
  public void offsetValueSubAggregation() throws Exception {
    ...
    ResultSet rs = conn.createStatement()
      .executeQuery("SELECT LAST_VALUES(SUM_VALUE, 2) WITHIN GROUP (ORDER BY MIN_DATE ASC) FROM ("
  ...
  public void testSortOrderInDataColWithOffset() throws Exception {
    ...
    ResultSet rs = conn.createStatement()
      .executeQuery("SELECT LAST_VALUES(\"value\", 2)  WITHIN GROUP (ORDER BY dates ASC) FROM "
        + tableName + " GROUP BY page_id");
  ...
  public void nonUniqueValuesInOrderByAsc() throws Exception {
    ...
    ResultSet rs = conn.createStatement()
      .executeQuery("SELECT LAST_VALUES(val, 3) WITHIN GROUP (ORDER BY dates ASC) FROM " + tableName
        + " GROUP BY page_id");
  ...
  public void nonUniqueValuesInOrderByAscSkipDuplicit() throws Exception {
    ...
    ResultSet rs = conn.createStatement()
      .executeQuery("SELECT LAST_VALUES(val, 5) WITHIN GROUP (ORDER BY dates ASC) FROM " + tableName
        + " GROUP BY page_id");
  ...
  public void nonUniqueValuesInOrderNextValueDesc() throws Exception {
    ...
    ResultSet rs = conn.createStatement()
      .executeQuery("SELECT LAST_VALUES(val, 2) WITHIN GROUP (ORDER BY dates DESC) FROM "
        + tableName + " GROUP BY page_id");
  ...
  public void ignoreNullValues() throws Exception {
    ...
    conn.createStatement().execute(
      "UPSERT INTO " + tableName + " (id, page_id, dates, \"value\") VALUES (5, 8, 4, NULL)");
    conn.createStatement()
  ...
  public void rowLessThanOffsetWithGroupBy() throws Exception {
    ...
    ResultSet rs = conn.createStatement()
      .executeQuery("SELECT LAST_VALUES(val, 2)  WITHIN GROUP (ORDER BY dates ASC) FROM "
        + tableName + " GROUP BY page_id");
