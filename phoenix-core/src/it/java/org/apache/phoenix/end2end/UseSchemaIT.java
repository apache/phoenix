...
public class UseSchemaIT extends ParallelStatsDisabledIT {
  ...
  public void testUseSchema(String schema) throws Exception {
    ...
    conn.createStatement().executeUpdate(
      "upsert into " + testTable + " values('" + SchemaUtil.SCHEMA_FOR_DEFAULT_NAMESPACE + "')");
    conn.commit();
  ...
  public void testSchemaInJdbcUrl() throws Exception {
    ...
    conn.createStatement()
      .executeUpdate("upsert into " + schema + "." + testTable + " values('" + schema + "')");
  ...
  public void testSequences() throws Exception {
    ...
    ddl =
      "create SEQUENCE " + schema + "." + sequenceName + " START WITH 100 INCREMENT BY 2 CACHE 10";
    conn.createStatement().execute(ddl);
  ...
  public void testMappedView() throws Exception {
    ...
    admin.createTable(TableDescriptorBuilder.newBuilder(TableName.valueOf(fullTablename))
      .addColumnFamily(ColumnFamilyDescriptorBuilder.of(QueryConstants.DEFAULT_COLUMN_FAMILY_BYTES))
      .build());
