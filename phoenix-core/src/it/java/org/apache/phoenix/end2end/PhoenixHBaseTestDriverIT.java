...
/**
 * This class drives the End2End execution of PhoenixHBase tests against an
 * already deployed distributed cluster .
 */
public class PhoenixHBaseTestDriverIT extends AbstractHBaseTool {
    ...
    public void main(String[] args) throws Exception {
      int ret = ToolRunner.run(new PhoenixHBaseTestDriverIT(), args);
      System.exit(ret);
    }
    ...
    public class End2EndTestFilter extends ClassTestFinder.TestClassFilter {
      private Pattern testFilterRe = Pattern.compile(".*PhoenixHBaseSuiteAtomicity*.*");
