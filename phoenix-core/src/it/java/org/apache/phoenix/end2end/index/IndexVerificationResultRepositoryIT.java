...
public class IndexVerificationResultRepositoryIT extends ParallelStatsDisabledIT {
  ...
  private IndexVerificationResultRepository setupResultRepository(Connection conn,
    byte[] indexNameBytes, IndexToolVerificationResult expectedResult)
  ...
  private void assertVerificationResult(IndexToolVerificationResult expectedResult,
    IndexToolVerificationResult actualResult) {
  ...
  private IndexToolVerificationResult getExpectedResult(long scanMaxTs) {
    ...
    IndexToolVerificationResult result =
      new IndexToolVerificationResult(startRow, stopRow, scanMaxTs);
  ...
  private void createTableAndIndex(Connection conn, String dataTableName, String indexTableName)
    throws Exception {
