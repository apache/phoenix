...
public class  ClientSideImmutableIndexIT extends BaseImmutableIndexIT {
  ...
  public ClientSideImmutableIndexIT(boolean localIndex, boolean transactional, String transactionProvider,
                                    boolean columnEncoded) {
    super(localIndex, transactional, transactionProvider, columnEncoded, false);
  }
  ...
  public static synchronized void doSetup() throws Exception {
    ...
    clientProps.put(QueryServices.SERVER_SIDE_IMMUTABLE_INDEXES_ENABLED_ATTRIB, "false");
    driver = null;
  ...
  @Parameters(
          name = "ClientSideImmutableIndexIT_localIndex={0},transactional={1},transactionProvider={2},columnEncoded={3}")
