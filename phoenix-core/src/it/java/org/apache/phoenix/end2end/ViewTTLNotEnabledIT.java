...
public class ViewTTLNotEnabledIT extends ParallelStatsDisabledIT {
  ...
  public void testPhoenixTTLNotEnabled() throws Exception {
    ...
    final PhoenixTestBuilder.SchemaBuilder schemaBuilder =
      new PhoenixTestBuilder.SchemaBuilder(url);
    ...
    HTableDescriptor tableDescriptor =
      admin.getTableDescriptor(TableName.valueOf(schemaBuilder.getEntityTableName()));
    Assert.assertFalse(
      "Coprocessor " + PhoenixTTLRegionObserver.class.getName() + " should not have been added: ",
    ...
    try (Connection conn = DriverManager.getConnection(tenantConnectUrl, props);
      ...
      Assert.assertEquals("PhoenixTTL should not be set", 0,
