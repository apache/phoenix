 ...
 * 0. Stats are disabled at table level. See
 * {@link org.apache.phoenix.schema.stats.NoOpStatsCollectorIT} for tests that disable stats
 * collection from server side. You must create unique names using {@link #generateUniqueName()} for
 * each table and sequence used to prevent collisions.
 */
public abstract class ParallelStatsDisabledIT extends BaseTest {
  ...
  protected void validateQueryPlan(Connection conn, QueryBuilder queryBuilder,
