...
public class AggregateQueryWithRegionMoves2IT extends AggregateQueryWithRegionMovesIT {
    ...
    private static final Logger LOGGER =
            LoggerFactory.getLogger(AggregateQueryWithRegionMoves2IT.class);

    private static int countOfValidResults = 0;

    @Parameterized.Parameters(name = "AggregateQueryWithRegionMoves2IT_{index}")
    public static synchronized Collection<Object> data() {
        return BaseQueryWithRegionMovesIT.allIndexes();
    }

    public AggregateQueryWithRegionMoves2IT(String indexDDL, boolean columnEncoded,
